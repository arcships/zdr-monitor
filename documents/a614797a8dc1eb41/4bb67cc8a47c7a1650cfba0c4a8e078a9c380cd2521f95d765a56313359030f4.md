...
URL Source: https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-threads
...
## Start a new thread and use it with Agent Run[¶](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-threads#start-a-new-thread-and-use-it-with-agent-run)

You must create a new thread, then pass it as part of a request to `agent:run`.

1.   Create a new thread using [Create thread](https://docs.snowflake.com/user-guide/snowflake-cortex/cortex-agents-threads-rest-api#label-cortex-agents-threads-rest-api-create).
...
[](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-threads)
## Read the returned message IDs[¶](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-threads#read-the-returned-message-ids)
...
[](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-threads)
## Continue the conversation[¶](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-threads#continue-the-conversation)
...
You must pass an assistant message ID as the `parent_message_id` to ensure the LLM functions as expected. You cannot pass a user message ID. If you have lost track of the last message ID, use [Describe thread](https://docs.snowflake.com/user-guide/snowflake-cortex/cortex-agents-threads-rest-api#label-cortex-agents-threads-rest-api-describe) to list all messages in the thread.
...
[](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-threads)
### Fork a conversation[¶](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-threads#fork-a-conversation)
...
### Step one: Fetch the latest summary[¶](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-threads#step-one-fetch-the-latest-summary)
...
### Step two: Fetch conversation messages after the summary[¶](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-threads#step-two-fetch-conversation-messages-after-the-summary)
