...
For translations of these Service Specific Terms into other languages,
...
These Service Specific Terms are incorporated into the
...
“ Cloud Data Processing Addendum ” (formerly referred to as the Data Processing
...
“ Documentation ” means the Google documentation (as may be updated
...
“ Scope of Use ” means any limits on installation or usage of Services or
...
at
https://cloud.google.com/terms/services (“Premium
...
https://cloud.google.com/terms/services ("Google-Managed
...
https://cloud.google.com/terms/user-experience-research or
a successor URL.
...
subject to Section 14(f) (Reseller Technical Support);
...
https://cloud.google.com/terms/data-portability (as may be updated from time
to time).
...
b . Customer Security Obligations . Google may
...
d.
Service Restrictions . Customer agrees to comply
...
f.
Licensing Portability Customers. If Customer is
...
g.
Prepaid 3-Year Committed Units . Partners purchasing
...
h.
Aria Suite. If Customer is using the “Aria Suite” in a self-managed
...
a. Simba ODBC/JDBC Drivers. The Simba ODBC and JDBC drivers for
BigQuery (described
...
b.
Capacity Adjustments. Google reserves the right to (1) deploy Services
...
a. Partner Interconnect . Customer will
...
b. Cross-Site Interconnect (CSI). Notwithstanding any
...
https://www.broadcom.com/company/legal/licensing ("Broadcom"). Customer
...
9. Cloud NGFW
and Cloud Intrusion Detection
System (Cloud IDS). Notwithstanding anything to
...
b. NCC Gateway . NCC Gateway enables Customer to
establish a connection to first-party and third-party security solutions
(“3PSS”), as described in the Documentation . Customer’s access to and use
...
a. Governing Agreement. This Section 11
...
12. Assured Open Source Software (AOSS). TSS is not
available for free tiers of AOSS.

13.
Google Device Cloud.

a. License Agreement. Customer’s access to and use of a Device
...
14. Definitions (formerly Section 13
(Definitions)) .

“ Agentic AI Services ” include (i) Gemini Enterprise and (ii) other
agentic artificial intelligence features or functionality of the Google
Cloud Platform Services.

“ AI Agents ” are goal-oriented, AI systems or workflows that perform
...
“ Customer Adapter Model ” means an adapter model
...
Model ” means a model trained or retrained by
...
“ Google Pre-Trained Model ” means a model trained by
Google and not released as an open model under an open
source or other license.

“ Modified Google Model ” means a Google
...
15. Intellectual Property Terms for AI/ML Services (formerly
Section 14 (Intellectual Property Terms for AI/ML Services)) .

a.
Non-Google Models . As between
...
16.
AI/ML Data Location (formerly Section 15 (AI/ML Data Location)) .
...
17.
Use Restrictions for AI/ML Services (formerly Section 16 (Use
Restrictions for AI/ML Services)) .

a.
Competitive Use. Customer will not, and will not
...
b . ​​Model Restrictions. Customer will not, and
...
c.
No Reverse Engineering . Customer will not, and will
...
18.
Training Restriction (formerly Section 17 (Training Restriction)) .
...
19.
Separate Offerings and Customer Models (formerly Section
...
b.
Disclaimer and Indemnity . Google disclaims all
...
20. Generative AI
Services (formerly Section 19 (Generative AI Services)) .
...
k . Grounding with Google Search . “Grounding with
...
(ii)
Storage for Debugging . Customer
...
(iii) Guidelines . If Customer builds
...
l . Web Grounding for Enterprise . Section 20(k)
...
m . Grounding with Google Maps . “Grounding with Google Maps” is a
...
Policy govern the destination page. Google
...
(ii) Storage for Debugging and Testing . Customer acknowledges that it
...
(ii) Customer's access to and use of Agentic AI Services in Third Party
Services . Customer's use of Third Party Services is not governed by the
...
o . Provisioned Throughput . Provisioned Throughput
...
21.
Agent Search on Gemini Enterprise Agent Platform (formerly Vertex AI Search) and Gemini Enterprise. With respect to these
...
24. Customer Engagement Suite (formerly
Contact Center AI (CCAI) Platform) .

a. No Access to
Emergency Services. Customer Engagement Suite includes
...
c. CX Agent Studio.
When Customer uses CX Agent Studio with web grounding,
...
replaced with “When Customer uses CX Agent Studio with web
...
are replaced with ”CX Agent Studio with web grounding”;
...
26.
Speech on Device (SOD) / Automotive AI Agent (AAA) Premium Software. Customer’s
...
27.
Automotive AI Agent. Automotive AI Agent models
...
31. Gemini Enterprise Agent Platform API
(formerly Vertex AI API)

(a) Gemini Cyber.

(i) Use Restrictions and Permitted Uses .
Customer will restrict access to and use of Gemini Cyber to End Users
authorized by Customer to engage in the Permitted Uses defined below (the
“ Permitted Users ”). Customer will ensure that access to and use of
Gemini Cyber is solely for the Permitted Uses, and is exclusively on: (a)
systems, networks, and codebases owned or operated by Customer; or (b)
third-party environments for which Customer has obtained prior written
authorization from the rightful system owner for the Permitted Uses.
“ Permitted Uses ” means:

Testing systems (including network, application, and adversary
simulation);

Discovering, analyzing, and responsibly disclosing software
vulnerabilities via source code analysis, reverse engineering, and fuzzing
authorized codebases;

Defensive analysis of malware, threat actor tactics, techniques or
procedures, indicators of compromise, and cyber threat trends;

Investigating and remediating security incidents, including digital
forensics, log analysis, malware triage, and containment;

Developing and testing defensive tools, including detection rules,
scanners, and automation tools;

Use in capture-the-flag events, training labs, and isolated research
environments to build skills and test hypotheses; and

Generating security patches, fixing vulnerabilities, and reviewing
codebases for security.

(ii) Specific Prohibitions . Without
limiting any other obligations of Customer under the Agreement, Customer will
not, and will not permit any End User to:

Use Gemini Cyber for malicious or unauthorized data exfiltration,
destruction, surveillance, or system compromise; or

Integrate Gemini Cyber into any third-party services, customer-facing
platforms, tools, harnesses, or applications (including Customer
Applications), or any Customer or third-party downstream software.

(iii) Access and Isolation . Customer
must require two-factor authentication for all Permitted Users and deploy
Gemini Cyber exclusively in a dedicated, isolated Project.

(iv) User Logging and Incident
Notification . Customer will maintain logs of prompts and outputs
generated by Permitted Users (" Permitted User Logs ") and promptly
notify Google if Customer becomes aware of any unauthorized third-party access
to Gemini Cyber or a security breach affecting the dedicated, isolated
Project.

(v) Enhanced Safety Protocol . Upon
Google’s reasonable request, Customer may provide, subject to Section
31(a)(vii) (De-Identification and Redaction) below, relevant Permitted User
Log extracts for use by Google solely to ensure safe and compliant use of
Gemini Cyber, including by investigating incidents reported by Customer under
Section 31(a)(iv) (the “ Purpose ”).

(vi) Treatment and Protection of Log
Extracts . Google will process any Permitted User Log extracts (which
will be considered Customer Data) for the Purpose in accordance with the Cloud
Data Processing Addendum (the “CDPA” ), provided that Customer instructs
Google under Section 6.1 of the CDPA General Terms (Deletion By Customer) to
delete such Customer Data from Google’s systems once no longer necessary for
the Purpose. Customer is solely responsible for providing any required notices
and obtaining any necessary consents or authorizations under applicable laws
and regulations for the logging and disclosure of Permitted User Log extracts
to Google.

(vii) De-Identification and Redaction .
Customer must sanitize any data from any extracts of the Permitted User Logs
that could directly or indirectly identify an individual (whether alone or
combined with other log data, metadata, or other available information) prior
to providing the extracts to Google for the Purpose. Customer may also redact
proprietary information or Customer Confidential Information from the
extracts. Any de-identification or redaction conducted pursuant to this
section must: (a) preserve consistent identifiers such that Customer can
attribute and correlate Permitted User activity; and (b) maintain all
timestamps, event types, and metadata relevant to the Purpose. Customer will
retain sole custody and control of any mapping keys or mechanisms used to link
identifiers to individual Permitted Users. Google will not request, and
Customer will not provide, any keys or information that would enable Google to
identify any individual Permitted User.

32. Gemini Enterprise and Gemini for
Government.

a. Additional Products. Google makes
...
b. "Additional Products" means products,
...
a. Hyperdisk Exapools. Customer and Google
...
34. Looker (Google Cloud core). If
...
a. Liability . Notwithstanding anything to the contrary in
...
b. Assured
Workloads Data Location . If Customer is using
...
c. ITAR Data. Notwithstanding any restriction on
...
e. Canada Controlled Goods. Notwithstanding any restriction on the
access or use of Services for Canadian controlled goods in the Agreement,
Customer may access or use the Services with software or technical data
subject to Canada’s Defence Production Act and the Controlled Goods
Regulations if Customer uses Assured Workloads Services explicitly
identified in the Documentation as being compatible with Canada’s
controlled goods requirements. Customers may not use any Services
to store or process classified information. Customers are responsible
for complying with the relevant Canada Controlled Goods Program requirements
...
c. Security Command Center Enterprise. The
...
43. Firebase Phone Number Verification
(Firebase PNV).

a. Privacy Requirements . At all times
...
b. Phone Number Usage . User data that
...
c. Policy Compliance . Customer will at
all times (i) comply
Google’s API Services User Data Policy , which covers
...
d. Enforcement . Google may audit
...
44. Google Cloud Fraud Defense
(formerly reCAPTCHA Enterprise).
...
b. Use. Google Cloud
Fraud Defense may only be used to fight fraud and abuse on
...
the Brand Phishing Protection
product, Evaluate API ,
or Submission API
...
46. Chrome Enterprise
Premium.

a. Chrome Enterprise
Core . In order to use Chrome Enterprise Premium
...
48.
Audit Manager. Reports generated by Audit Manager
...
49. Google Distributed Cloud connected (formerly Google Distributed
Cloud Edge) . If you purchased Google Distributed Cloud connected prior
...
50. Data Boundary by Partners (formerly Sovereign Controls
by Partners) .

a. Customer Responsibilities. The Data Boundary by Partners solution
...
51.
AlloyDB Omni. Customer and its Software Users (as
...
b. Additional
Restrictions. Customer will not (either directly or
...
" Free Evaluation Services " means (a)
...
" Free Model " means a version of an
...
" Google Personnel " means Google’s and
its Affiliates’ employees, agents, and subcontractors.

" Materials " means tools, code,
...
b. Scope . Google will provide Free
...
c. Terms . Free Evaluation Services are
...
d. Materials . While Materials may be
...
(i) Non-Production Environment . Customer will
...
(ii) Customer Personal Data . Customer will not
...
f. AI Services . If Free Evaluation
...
https://policies.google.com/terms/generative-ai/use-policy , and the
...
b. Introduction . The Delivery Navigator Platform
...
c. Application of Terms and Definitions . Notwithstanding anything to the contrary in the Agreement:

(i) Account . Google will provision Customer with a Delivery Navigator Account.

(ii) Admin Console . The Admin Console for the Delivery Navigator Platform is separate and distinct
from the Google Cloud Platform Admin Console.

(iii) Customer Application and Project . References to a "Customer Application" or "Project" are inapplicable to
the Delivery Navigator Platform.

d. Free Offering . Delivery Navigator Platform is a free offering, with no Fees due.

(i) Government Entity . If Customer is a government entity and is offered access to the Delivery
...
e. Customer Data Processing Addendum . Customer may upload certain progress and task materials associated with
...
f. Third-Party Software . Customer is solely responsible for its use (including procuring the
applicable licenses) and configuration of any Third-Party Software.

g. Disclaimers . THE DELIVERY NAVIGATOR PLATFORM IS PROVIDED “AS IS” WITHOUT ANY EXPRESS OR
...
i. PSO Partners . If Customer is: (a) part of the Google Cloud Partner Advantage Program (as described at partneradvantage.goog) and (b) delivers professional services to its own customers to facilitate their use of Google Cloud products and services, then the following additional terms apply:

(i) Customer may download and integrate Content
into any Google Cloud deliverables that Customer provides to Customer's
customers .

(ii) Customer's customers may use Content
...
(iii) Customer will not remove any Google
...
at https://www.redhat.com/licenses/cloud_cssa/ .
...
https://github.com/NVIDIA/open-gpu-kernel-modules will
...
4. Oracle JDBC Driver in Looker (Google Cloud
core) only.
...
and Squarespace’s Privacy Policy .
...
a. Selection and
Commitment . If Customer purchases Committed Units,
...
c. Cancellation and
Expiration . If Google serves notice to non-renew
...
d. No Resell or
Transfer . Unless Google agrees otherwise, Customer
...
“ SAP S/4HANA Cloud Contract ” means the separate
...
“ Committed Unit
Term ” means the period of time during which
Customer is obligated to pay for the Committed Units.

“ Fees URL ”
means https://cloud.google.com/skus .
...
“Paid Credits” has the meaning given in
...
1. Modification of Terms. The following amendments to these Service
...
2. Partner Software Terms. The following apply to Partner’s use of Software
...
b. Provision Limitations . Unless Google has provided specific
...
“SAP” means SAP SE, a company registered in Germany, or its Affiliate, as
applicable.

“SAP S/4HANA Cloud Contract” means the separate contract between
...
4. Generative AI Safety and Abuse for GCP Services.
Google uses automated safety tools to detect abuse of Generative AI Services.
Notwithstanding the "Handling of Prompts and Generated Output" section in the
Service Specific Terms for GCP Services, if these tools detect potential
abuse or violations of Google’s
AUP
or Prohibited Use Policy ,
Google may log
prompts made by Partner or a Non-TOS Customer solely for the purpose of
reviewing and determining whether a violation has occurred. See the
Abuse
Monitoring documentation page for more information about how logging prompts
