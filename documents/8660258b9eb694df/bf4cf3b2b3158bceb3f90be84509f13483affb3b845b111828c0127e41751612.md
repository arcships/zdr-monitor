Title: Replit shared responsibility model - Replit

URL Source: https://docs.replit.com/features/security/shared-responsibility-model
...
| Data residency | Where application development data is stored and processed. Pro customers can choose a Workspace location during creation. See [Workspace geography](https://docs.replit.com/features/collaboration/workspace-geography). | Replit |
