Title: Multi-tenant Cloud - Weights & Biases Documentation

URL Source: https://docs.wandb.ai/platform/hosting/hosting-options/multi_tenant_cloud
...
*   [Configure user roles](https://docs.wandb.ai/platform/hosting/iam/access-management/manage-organization#assign-or-update-a-users-role) at the scope of the organization and within a team.
