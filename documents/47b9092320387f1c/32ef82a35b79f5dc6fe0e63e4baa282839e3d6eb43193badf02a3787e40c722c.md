...
Privacy Policy
Effective September 10, 2026 Previous Version English
...
Third-Party Websites, Integrations, and Services: Our Services allow you to connect to and interact with third-party applications, services, and content (“Third-Party Services”) via the Services and through integrations you enable, such as Connectors, plugins, webhooks, and external APIs. When you connect to or interact with Third-Party Services: Claude may send your Inputs, Outputs, and instructions to Third-Party Services to perform actions on your behalf (such as reading files, sending messages, or retrieving information). The Third-Party Service receives this data directly and processes it according to its own privacy policy.
...
To provide you with service updates, communications, and to provide tailored recommendations about our Services that may be of interest to you. Identity and Contact Data
...
To investigate and resolve disputes Identity and Contact Data
Payment Information
Inputs and Outputs
Feedback
Technical Information
...
To investigate and resolve security issues Identity and Contact Data
Payment Information
Feedback
Technical Information
Inputs and Outputs
...
To improve the Services and conduct research (including model training). See our Non-User Privacy Policy for more details on the data used to train our models, and the different stages of development. Feedback
Study Participation Data
Inputs and Outputs
...
Anthropic delegates the processing of personal data as described here and below, and the delegatees may process personal data according to the purpose of the delegation.
...
Anthropic delegates the processing of personal data to affiliates  and  third parties , all of whom are located overseas. In addition, Anthropic transfers personal data overseas as follows:
...
Following collection, personal data is transferred to the overseas recipients listed below from time to time, as necessary, via a dedicated network. You may have the right to request that your personal data not be transferred overseas as described above. If so, you may request this by email us at privacy@anthropic.com and contact our Data Protection Officer at dpo@anthropic.com . However, in doing so, Anthropic may not be able to provide you with all or any of the services we make available through our website.
...
Email: anthropic_privacy@kimchang.com
