...
URL Source: https://help.aliyun.com/zh/model-studio/token-plan-overview
...
[首页](https://help.aliyun.com/zh)[大模型服务平台百炼](https://help.aliyun.com/zh/model-studio/)[Token Plan](https://help.aliyun.com/zh/model-studio/token-plan-guide/)Token Plan 概述

# Token Plan 概述

更新时间：2026-09-22 15:52:57
...
Token Plan 目前仅支持**华北 2（北京）**地域，请在[百炼控制台](https://bailian.console.aliyun.com/cn-beijing/subscription/token-plan)左上角将地域切换至**华北 2（北京）**后购买并使用。
...
*   **个人版**：面向个人开发者，提供 Lite、Essential、Standard、Pro 四档套餐，设有订阅月 Credits 限额，档位越高额度越大。
...
| **购买条件** | - | 需有效订阅，最多 5 个 |
| **模型** | 支持文本生成、图像生成、视频生成、语音识别、实时语音对话等多种模型（[查看完整列表](https://help.aliyun.com/zh/model-studio/token-plan-personal-overview#tpp01-h-models)） |
| **模型内置工具** | 支持多种模型内置工具，以 Credits 统一抵扣（[查看详情](https://help.aliyun.com/zh/model-studio/token-plan-personal-overview#tpp01-h-harness)） |
| **Harness 权益** | Standard 与 Pro 套餐附赠 AgentStudio 工具免费额度与折扣，不占 Credits（[查看详情](https://help.aliyun.com/zh/model-studio/token-plan-harness-benefits)） |
...
| **模型** | 支持文本生成、图像生成、视频生成、语音识别、实时语音对话等多种模型（[查看完整列表](https://help.aliyun.com/zh/model-studio/token-plan-team-overview#tpt01-h-models)） |
| **模型内置工具** | 支持多种模型内置工具，以 Credits 统一抵扣（[查看详情](https://help.aliyun.com/zh/model-studio/token-plan-team-quickstart#tpt02-h-optional-tool)） |
| **团队管理** | 支持多席位管理和用量分析（[团队管理](https://help.aliyun.com/zh/model-studio/token-plan-team-management)） |

## 套餐限额

### 个人版

个人版采用月限额，限额单位为 Credits：

*   **月额度**：自订阅当日起向后延伸 30 天作为订阅周期，订阅周期内累计消耗达到套餐额度后暂停服务，需等待下一个订阅月后额度恢复。

月额度触顶即暂停服务，可购买用量包补充额度继续使用，或等待下一个订阅月额度重置。订阅月内未用完的额度不结转至下一周期。

### 团队版

团队版采用月度总额度制。每个座席的月度额度在计费周期内可用，到期未使用的额度不结转。超出月度总额度后调用将被阻断，可购买共享用量包补充额度。计费周期按订购日起算（订阅月，非自然月）。例如 6 月 4 日订阅，则本计费周期有效期至下月 4 日。订阅后，系统按订阅月一次性发放全量月度额度，而非按天发放。续费仅延长订阅有效期，不会为当前计费周期叠加补充额度。
...
Coding Plan 和 Token Plan 是两个独立的订阅产品，两者之间无法迁移或升级。Coding Plan Lite 已于 2026 年 3 月 20 日停止新购，2026 年 4 月 13 日停止续费和升级；Coding Plan Pro 为限量抢购，库存售罄后不再补充。推荐使用 **Token Plan**，支持更多模型和模型内置工具。

[上一篇：预算管理](https://help.aliyun.com/zh/model-studio/budget-management)[下一篇：个人版](https://help.aliyun.com/zh/model-studio/token-plan-personal/)
...
[快捷注册](https://account.aliyun.com/register/qr_register.htm?oauth_callback=https%3A%2F%2Fhelp.aliyun.com%2Fzh%2Fmodel-studio%2Ftoken-plan-overview)[登录阿里云](https://account.aliyun.com/login/login.htm?oauth_callback=https%3A%2F%2Fhelp.aliyun.com%2Fzh%2Fmodel-studio%2Ftoken-plan-overview)
