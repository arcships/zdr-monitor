Title: Terms of Service | OpenRouter

URL Source: https://openrouter.ai/terms

Markdown Content:
[Skip to content](https://openrouter.ai/terms#skip)
...
*   [Tools](https://openrouter.ai/tools)
...
You are responsible for maintaining the confidentiality and security of all API keys, tokens, passwords, and other credentials used to access the Service ("**API Credentials**"). You are responsible for all activity and charges under its account or API Credentials, whether or not authorized by you, except to the extent caused directly by OpenRouter's breach of these Terms. You agree to promptly notify OpenRouter of any actual or suspected compromise or unauthorized use of API Credentials. OpenRouter may suspend, revoke, or limit API Credentials or account access if OpenRouter reasonably believes doing so is necessary to protect the Service, you, OpenRouter, or any third party.
...
OpenRouter may in its discretion provide Credits to you free of charge as part of a promotional program, trial, or similar offering, which may include, without limitation, the [Startup Program](https://openrouter.ai/startups) ("**Promo Credits**"). Promo Credits may only be used on the Service, have no cash value, are not legal tender, are non-refundable and non-exchangeable, and the refund rights described in Section 4.1 do not apply to Promo Credits. Promo Credits will not be applied against any sales, use, gross receipts, or similar transaction-based taxes that may apply to you. Any Promo Credits granted are personal to your account and are non-transferable. Promo Credits expire on the date specified when issued or, if no expiration date is specified, in accordance with Section 4.2. OpenRouter may modify, suspend, or revoke Promo Credits at any time, provided that such changes do not retroactively reduce or invalidate the value of Promo Credits already issued and unexpired, except as permitted by law. If your account contains both purchased Credits and Promo Credits, OpenRouter may determine the order in which those Credits are applied when you use the Service. If you are a participant in the Startup Program, the [Startup Terms and Conditions](https://openrouter.ai/startup-program-terms) ("**Startup Terms**") will govern in the event of a conflict between the Startup Terms and these Terms with respect to Promo Credits only.

## 4.4 Nature of Credits

Credits are not legal tender or currency, have no equivalent value in fiat currency, do not act as a substitute for fiat currency, and do not constitute or confer any personal property right. Credits are not redeemable, refundable, or exchangeable for any sum of money or monetary value, except for (i) the refunds described in Section 4.1, (ii) the refund of remaining Credits upon termination described in Section 9, or (iii) as required by applicable law. Credits are non-transferable, including between accounts, and may be used only in connection with the Service.

## 4.5 Currency; Payment Processing

OpenRouter will charge the payment method you specify at the time of purchase. You authorize OpenRouter to charge all sums as described in these Terms, for the Service you select, to that payment method. OpenRouter accepts payment through our third-party payment processors, Stripe and Coinbase. All payments made through Stripe are in U.S. dollars, and payments made through Coinbase are through your crypto wallet. See Stripe's payment terms and conditions [here](https://stripe.com/legal/ssa), and Coinbase payment terms and conditions [here](https://www.coinbase.com/legal/user_agreement/united_states). If you choose to pay using Coinbase, you represent and warrant that the cryptocurrency and source of funds for the cryptocurrency you use do not constitute the proceeds of a financial crime or any other crime under applicable law.
...
You acknowledge that the Service enables you, your Authorized Users, and your customers (to the extent you incorporate the Service into your own products and services) access to Models provided by Model Providers. By accessing or using any Model through the Service, you agree, and will ensure that your Authorized Users and customers agree, to comply with the applicable terms for each Model ("**Model Terms**"), a list of which is provided [here](https://openrouter.ai/docs/features/provider-routing#terms-of-service). You are solely responsible for reviewing the Model Terms applicable to each Model before accessing or using that Model and for determining whether the applicable Model Terms allow you and your Authorized Users to access and use the Service, Inputs, and Outputs as you intend. If you are accessing any Models that are part of the Stealth Program, you further agree to the [Stealth Program End User License Agreement](https://openrouter.ai/terms/stealth), which is incorporated herein by reference.
...
## 6.3 Storage of User Content

**(a) Opt-In Storage (Private Prompt Storage).** Private Prompt Storage is a feature on the Service that allows you to privately save your User Content so you can review it later, such as for debugging purposes. If you have enabled Private Prompt Storage, you grant OpenRouter a worldwide, revocable, non-exclusive, royalty-free, fully paid right and license to host, store, copy, and use your User Content solely for purposes of displaying the User Content to you. The User Content is only visible to your Admin User if you are part of an organizational account, or only to you, if you have an individual account.

**(b) Processing-Related Storage.** Certain features of the Service, such as batch or other large-volume request processing, require OpenRouter to temporarily store your User Content in order to process, route, and fulfill your request, including where the volume or size of a request cannot be processed in memory. You grant OpenRouter a worldwide, non-exclusive, royalty-free, fully paid right and license to host, store, copy, and use your User Content solely for such processing purposes. OpenRouter does not access User Content stored under this Section 6.3(b) except as necessary to operate, secure, or troubleshoot the Service, or as required by law. Availability of features that involve storage under this Section 6.3(b) for accounts that have enabled zero data retention or other settings referenced in Section 3 is described in the documentation for the applicable feature.

**(c) Retention.** Retention periods for User Content stored under this Section 6.3 vary by feature and are described in the applicable feature documentation, including [here](https://openrouter.ai/docs/guides/features/input-output-logging) and [here](https://openrouter.ai/docs/guides/privacy/data-collection). OpenRouter may update these retention periods from time to time by updating such documentation.
...
We are under no obligation to edit or control Inputs that you or other users post or publish, and will not be in any way responsible or liable for Inputs. OpenRouter may, however, at any time and without prior notice, screen, remove, edit, or block any Inputs that in our sole judgment violates these Terms or is otherwise objectionable or illegal. This includes screening Inputs for known child sexual abuse material (CSAM) and malware using automated detection tools. Nothing in this Section 6.7 or Section 6.9 limits or waives OpenRouter's own independent obligations under applicable law, including the obligation to report apparent CSAM to the National Center for Missing & Exploited Children (NCMEC) under 18 U.S.C. § 2258A. You agree to waive, and do waive, any legal or equitable right or remedy you have or may have against OpenRouter with respect to the Inputs. We expressly disclaim any and all liability in connection with User Content. If notified by a user, content owner or Model that User Content allegedly does not conform to these Terms, we may investigate the allegation and elect to terminate your access to the Services, in our discretion. For clarity, OpenRouter does not permit copyright-infringing activities on the Service.
...
## 6.9 Files and File Storage (Files API)

To the extent the Service permits you to upload, store, and retrieve files (including without limitation images, PDFs, and other documents) for use in connection with inference requests ("**Uploaded Files**"), Uploaded Files are Input under Section 6.1 and are subject to this Section 6.9 in addition to the other provisions of this Section 6.

You represent and warrant that you own or have all necessary rights, licenses, consents, and permissions to upload, store, and use each Uploaded File as contemplated by these Terms. You agree not to upload or store any Uploaded File that: (a) contains child sexual abuse material (CSAM) or otherwise exploits or endangers minors; (b) contains malware, viruses, or other malicious code; (c) infringes, misappropriates, or otherwise violates any intellectual property, privacy, publicity, or other right of a third party; or (d) otherwise violates applicable law or these Terms.

We may, but are under no obligation to, screen, scan, review, or remove any Uploaded File at any time and without notice, including through automated screening for known CSAM and malware, whether or not that screening runs before, during, or after an Uploaded File is transmitted to a Model Provider as described below. We may suspend or terminate your access to the Service and may report Uploaded Files to law enforcement or other authorities as required or permitted by applicable law. For clarity, nothing in this Section 6.9 or in Section 6.7 limits or waives OpenRouter's own independent obligations under applicable law, including the obligation to report apparent CSAM to the National Center for Missing & Exploited Children (NCMEC) under 18 U.S.C. § 2258A.

When you submit an Uploaded File with an inference request, that Uploaded File will be transmitted to, and processed by, the Model Provider you select (or that is selected on your behalf) to fulfill that request, in the same manner as other Inputs described in Section 6.1 and the Model Terms. We do not use the content of Uploaded Files for any purpose other than fulfilling your request and operating, securing, and maintaining the Service, including the screening described above.

We retain Uploaded Files until you delete them or close your account, as described in our Privacy Policy. Upon deletion, we will remove Uploaded Files, including cached and replicated copies, within the timeframes described in our Privacy Policy, except where retention is required by law or for legitimate legal, security, or backup purposes for a limited period thereafter. To the maximum extent permitted by applicable law, we are not liable for any loss, corruption, or unauthorized access to Uploaded Files, except to the extent caused by our gross negligence or willful misconduct, and you are solely responsible for maintaining independent backup copies of any Uploaded Files.

We may impose limits on the size, file type, and upload frequency of Uploaded Files, and may reject or remove any Uploaded File that exceeds these limits, at our sole discretion.

## 6.10 DMCA Notice and Takedown; Repeat Infringer Policy

OpenRouter respects the intellectual property rights of others and expects users of the Service to do the same. In accordance with the Digital Millennium Copyright Act ("**DMCA**"), OpenRouter has designated an agent to receive notifications of claimed copyright infringement relating to material uploaded, stored, or made available through the Service. OpenRouter's designated agent for receipt of such notifications is: DMCA Agent, OpenRouter, Inc., 169 Madison Avenue, New York, NY 10016, United States, email: [[email protected]](https://openrouter.ai/cdn-cgi/l/email-protection#dcbfb3aca5aeb5bbb4a89cb3acb9b2aeb3a9a8b9aef2bdb5). This designation will be filed with the U.S. Copyright Office's Designated Agent Directory. To be effective, a notification of claimed infringement must comply with the requirements of 17 U.S.C. § 512(c)(3). This Section 6.10 serves as OpenRouter's company-wide policy governing claims of copyright infringement submitted through the Service, including with respect to Customer Content or other material submitted under a separate agreement (such as a Subscription Agreement) that incorporates this Section by reference.

In appropriate circumstances and at our sole discretion, we will terminate the accounts of, or otherwise restrict access to the Service by, users who are determined to be repeat infringers of the intellectual property rights of others, consistent with the DMCA and other applicable law.
...
9.   upload or store, or attempt to upload or store, any file through the Files API (or any other file-upload feature of the Service) that you know or reasonably should know contains child sexual abuse material, malware, or other content prohibited by Section 6.9;

10.   interfere with security-related features of the Service, including without limitation, by: (a) disabling or circumventing features that prevent or limit use or copying of any content; or (b) reverse engineering or otherwise attempting to discover the source code of any portion of the Service except to the extent that the activity is expressly permitted by applicable law;

11.   conduct, or work with any third parties to conduct, without OpenRouter's prior written approval, any Red Teaming of Models. "**Red Teaming**" means prompt injection, jailbreaking, or taking any other adversarial action designed to compromise any Models and/or violate any Model Terms;

12.   interfere with the operation of the Service or any user's enjoyment of the Service, including by: (a) uploading or otherwise disseminating any virus, adware, spyware, worm, or other malicious code; (b) making any unsolicited offer or advertisement to another user of the Service; (c) attempting to collect personal information about another user or third party without consent; or (d) interfering with or disrupting any network, equipment, or server connected to or used to provide the Service, or violating any regulation, policy, or procedure of any such network, equipment, or server;

13.   perform any fraudulent activity including impersonating any person or entity, claiming a false affiliation, accessing any other Service account without permission, or falsifying your age or date of birth;

14.   sell or otherwise transfer the access granted under these Terms or any Materials (as defined in 12) or any right or ability to view, access, or use any Material; or

15.   attempt to do any of the acts described in this Section 7, or assist or permit any person in engaging in any of the acts described in this Section 7.

### 8. Red Teaming

As Red Teaming is a violation of many Model Terms, OpenRouter allows Red Teaming only for legitimate research purposes and requires users interested in Red Teaming to first submit a written request. Any unauthorized Red Teaming will be flagged by OpenRouter's and Model providers' monitoring systems and are likely to result in account and access termination by Model providers. If you would like to conduct Red Teaming exercises, please review our Red Teaming documentation [here](https://openrouter.ai/docs/cookbook/evaluate-and-optimize/red-teaming) and submit an appropriate request. OpenRouter will review each request and approve or deny in writing, often within five (5) business days. Approval is granted on a case-by-case basis and is not guaranteed.

### 9. Termination of Use; Discontinuation and Modification of the Service

You may terminate your account at any time by contacting customer service at [[email protected]](https://openrouter.ai/cdn-cgi/l/email-protection). If you terminate your account, you remain obligated to pay all outstanding fees, if any, incurred prior to termination relating to your use of the Service. If you violate any provision of these Terms, your permission from us to use the Service will terminate automatically, and any unused Credits will not be refunded.
...
Please read the OpenRouter [Privacy Policy](https://openrouter.ai/privacy) carefully for information relating to our collection, use, storage and disclosure of your personal information on the Site. The OpenRouter Privacy Policy is incorporated by this reference into, and made a part of, these Terms.

## 10.2 Data Processing Agreement

If you are part of and represent an organization in entering into these Terms or use the Service for commercial, for-profit purposes, please read the OpenRouter [Data Processing Agreement](https://openrouter.ai/data-processing-agreement) ("**DPA**") relating to our processing of your Personal Data (as defined in the DPA). The DPA is incorporated by reference into, and made a part of, these Terms.
...
*   Stripe Projects: [Developer Terms for Stripe Projects](https://stripe.com/legal/projects-developer-terms)
...
1.   IN NO EVENT WILL THE OPENROUTER ENTITIES BE LIABLE TO YOU FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR PUNITIVE DAMAGES (INCLUDING DAMAGES FOR LOSS OF PROFITS, GOODWILL, OR ANY OTHER INTANGIBLE LOSS) ARISING OUT OF OR RELATING TO YOUR ACCESS TO OR USE OF, OR YOUR INABILITY TO ACCESS OR USE, THE SERVICE OR ANY MATERIALS OR CONTENT ON THE SERVICE, WHETHER BASED ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE), STATUTE, OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT ANY OPENROUTER ENTITY HAS BEEN INFORMED OF THE POSSIBILITY OF DAMAGE.

2.   EXCEPT AS PROVIDED IN SECTION 19.4(iii), THE AGGREGATE LIABILITY OF THE OPENROUTER ENTITIES TO YOU FOR ALL CLAIMS ARISING OUT OF OR RELATING TO THE USE OF OR ANY INABILITY TO USE ANY PORTION OF THE SERVICE OR OTHERWISE UNDER THESE TERMS, WHETHER IN CONTRACT, TORT, OR OTHERWISE, IS LIMITED TO THE GREATER OF: (A) THE AMOUNT YOU HAVE PAID TO OPENROUTER FOR ACCESS TO AND USE OF THE SERVICE IN THE 12 MONTHS PRIOR TO THE EVENT(S) OR CIRCUMSTANCES GIVING RISE TO CLAIM; OR (B) $100. SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF LIABILITY FOR CONSEQUENTIAL OR INCIDENTAL DAMAGES. ACCORDINGLY, THE ABOVE LIMITATION MAY NOT APPLY TO YOU.

3.   EACH PROVISION OF THESE TERMS THAT PROVIDES FOR A LIMITATION OF LIABILITY, DISCLAIMER OF WARRANTIES, OR EXCLUSION OF DAMAGES IS INTENDED TO AND DOES ALLOCATE THE RISKS BETWEEN YOU AND OPENROUTER UNDER THESE TERMS. THIS ALLOCATION IS AN ESSENTIAL ELEMENT OF THE BASIS OF THE BARGAIN BETWEEN YOU AND OPENROUTER. EACH OF THESE PROVISIONS IS SEVERABLE AND INDEPENDENT OF ALL OTHER PROVISIONS OF THESE TERMS. THE LIMITATIONS IN THIS SECTION 17 WILL APPLY EVEN IF ANY LIMITED REMEDY FAILS OF ITS ESSENTIAL PURPOSE.
...
The Service is offered by OpenRouter, Inc., located at 169 Madison Avenue, New York, NY 10016, United States. You may contact us by sending correspondence to that address or by emailing us at [[email protected]](https://openrouter.ai/cdn-cgi/l/email-protection).
