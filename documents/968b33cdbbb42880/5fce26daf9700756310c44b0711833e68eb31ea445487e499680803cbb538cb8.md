...
OpenRouter respects the intellectual property rights of others and expects users of the Service to do the same. In accordance with the Digital Millennium Copyright Act ("**DMCA**"), OpenRouter has designated an agent to receive notifications of claimed copyright infringement relating to material uploaded, stored, or made available through the Service. OpenRouter's designated agent for receipt of such notifications is: DMCA Agent, OpenRouter, Inc., 169 Madison Avenue, New York, NY 10016, United States, email: [[email protected]](https://openrouter.ai/cdn-cgi/l/email-protection#2d4e425d545f444a45596d425d48435f425859485f034c44). This designation will be filed with the U.S. Copyright Office's Designated Agent Directory. To be effective, a notification of claimed infringement must comply with the requirements of 17 U.S.C. § 512(c)(3). This Section 6.10 serves as OpenRouter's company-wide policy governing claims of copyright infringement submitted through the Service, including with respect to Customer Content or other material submitted under a separate agreement (such as a Subscription Agreement) that incorporates this Section by reference.
