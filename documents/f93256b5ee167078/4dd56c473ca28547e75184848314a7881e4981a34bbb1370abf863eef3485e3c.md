...
URL Source: https://help.aliyun.com/zh/model-studio/coding-plan
...
[首页](https://help.aliyun.com/zh)[大模型服务平台百炼](https://help.aliyun.com/zh/model-studio/)[Token Plan](https://help.aliyun.com/zh/model-studio/token-plan-guide/)[Coding Plan](https://help.aliyun.com/zh/model-studio/coding-plan-guide/)Coding Plan概述

# Coding Plan概述

更新时间：2026-09-11 05:54:20
...
|  | **Pro 高级套餐** |
| --- | --- |
| 支持的模型 | 仅支持以下精确版本： 推荐模型：**qwen3.7-plus**（支持图片理解）、**qwen3.6-plus**（支持图片理解）、**kimi-k2.5**（支持图片理解）、**glm-5**、**MiniMax-M2.5** 更多模型：qwen3.5-plus（支持图片理解）**、**qwen3-max-2026-01-23、qwen3-coder-next、qwen3-coder-plus、glm-4.7 |
| 价格 | **¥ 200**/月 |
| 用量限制 | * 每 5 小时**6,000** 次请求 * 每周**45,000** 次请求 * 每月**90,000** 次请求 |
...
*   **额度消耗：**单次提问将按实际“模型调用次数”扣除额度。简单任务约消耗 5-10 次，复杂任务约 10-30+ 次，实际消耗受任务难度、上下文及工具使用影响。在[Coding Plan 页面](https://bailian.console.aliyun.com/cn-beijing/subscription/coding-plan)可以查看用量。
...
1.   **添加用户：**使用主账号登录阿里云百炼，访问目标工作空间的 [权限管理](https://bailian.console.aliyun.com/cn-beijing/model/settings/permission)页面，点击**新增用户**添加该 RAM 用户，并定义用户名称，单击**确定**。![Image 16: image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4734072771/p1057319.png)
2.   **授予权限：**点击该用户右侧的**权限管理**，添加**管理员**权限，然后点击**确定**完成授权。![Image 17: image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4734072771/p1057328.png)

### 步骤二：获取套餐 API Key 和 Base URL

您需要获取并配置套餐的 API Key 和 Base URL，才能正确使用并抵扣套餐额度。

*   **API Key**：在[Coding Plan 页面](https://bailian.console.aliyun.com/cn-beijing/subscription/coding-plan)，获取 Coding Plan API Key（格式为`sk-sp-xxxxx`）。

*   **Base URL**：后续需在 AI 工具中配置以下其中一个 Base URL（因工具而异），具体操作请参见对应的 AI 工具文档。
...
Coding Plan 的 API Key 和 Base URL 与百炼按量计费的 API Key（`sk-xxxxx`）和 Base URL（`https://dashscope.aliyuncs.com/xxxxxx`）不互通，请勿混用。

### 步骤三：接入 AI 工具

![Image 18](https://unpkg.com/@lobehub/icons-static-svg@latest/icons/openclaw-color.svg)**[OpenClaw](https://help.aliyun.com/zh/model-studio/openclaw)**
开源、自托管个人 AI 助手![Image 19](https://unpkg.com/@lobehub/icons-static-svg@latest/icons/nousresearch.svg)**[Hermes Agent](https://help.aliyun.com/zh/model-studio/hermes-agent)**
开源 AI 代理框架，内置自学习循环![Image 20](https://unpkg.com/@lobehub/icons-static-svg@latest/icons/claude-color.svg)**[Claude Code](https://help.aliyun.com/zh/model-studio/claude-code)**
AI 终端编码助手，支持自然语言编程
![Image 21](https://unpkg.com/@lobehub/icons-static-svg@latest/icons/opencode.svg)**[OpenCode](https://help.aliyun.com/zh/model-studio/opencode)**
开源 AI 编程代理工具![Image 22](https://unpkg.com/@lobehub/icons-static-svg@latest/icons/cursor.svg)**[Cursor](https://help.aliyun.com/zh/model-studio/cursor)**
AI 原生代码编辑器![Image 23](https://unpkg.com/@lobehub/icons-static-svg@latest/icons/codex.svg)**[Codex](https://help.aliyun.com/zh/model-studio/codex)**
OpenAI 推出的命令行编程工具
![Image 24](https://unpkg.com/@lobehub/icons-static-svg@latest/icons/qwen-color.svg)**[Qwen Code](https://help.aliyun.com/zh/model-studio/qwen-code)**
开源命令行 AI 编码工具![Image 25](https://cdn.jsdelivr.net/gh/agentscope-ai/QwenPaw@main/website/public/qwenpaw-symbol.png)**[QwenPaw](https://help.aliyun.com/zh/model-studio/qwenpaw)**
开源个人 AI 助手，支持本地与云端部署![Image 26](https://unpkg.com/@lobehub/icons-static-svg@latest/icons/cherrystudio-color.svg)**[Cherry Studio](https://help.aliyun.com/zh/model-studio/cherry-studio)**
多模型桌面客户端
![Image 27](https://cdn.jsdelivr.net/gh/chatboxai/chatbox@main/assets/icon.png)**[Chatbox](https://help.aliyun.com/zh/model-studio/cline-tool)**
跨平台 AI 桌面客户端![Image 28](https://unpkg.com/@lobehub/icons-static-svg@latest/icons/cline.svg)**[Cline](https://help.aliyun.com/zh/model-studio/cline)**
VS Code 扩展，智能代码补全和调试![Image 29](https://unpkg.com/@lobehub/icons-static-svg@latest/icons/qoder-color.svg)**[Qoder](https://help.aliyun.com/zh/model-studio/qoder-agent)**
面向真实软件开发的 Agentic 编码平台
![Image 30](https://unpkg.com/@lobehub/icons-static-svg@latest/icons/bailian-color.svg)**[Lingma](https://help.aliyun.com/zh/model-studio/lingma-agent)**
阿里云智能编码助手，提供独立 IDE![Image 31](https://unpkg.com/@lobehub/icons-static-svg@latest/icons/kilocode.svg)**[Kilo CLI](https://help.aliyun.com/zh/model-studio/kilo-cli)**
轻量高性能命令行编程工具**[更多工具](https://help.aliyun.com/zh/model-studio/more-tools)**
其他编程工具

### 步骤四：开始使用

完成以上步骤后，可前往[Coding Plan 使用指南](https://bailian.console.aliyun.com/cn-beijing/model/market)查看详细用法。
...
误用了百炼通用 API Key 和 Base URL，系统会识别为按量付费，导致额外扣费。请改用 Coding Plan API Key（以`sk-sp-`开头）和套餐 Base URL（含`coding.dashscope.aliyuncs.com`），配置方法请参见[获取套餐 API Key 和 Base URL](https://help.aliyun.com/zh/model-studio/coding-plan#2531c37fd64f9)。
...
[上一篇：Coding Plan](https://help.aliyun.com/zh/model-studio/coding-plan-guide/)[下一篇：常见问题](https://help.aliyun.com/zh/model-studio/coding-plan-faq)
...
![Image 32: 阿里云APP](https://img.alicdn.com/imgextra/i4/O1CN01XLesV31fkf7pYNATb_!!6000000004045-2-tps-400-400.png)![Image 33: 阿里云微信](https://img.alicdn.com/tfs/TB1AOdINW6qK1RjSZFmXXX0PFXa-258-258.jpg)
联系我们：4008013260
...
##### ![Image 36: 文本生成](https://img.alicdn.com/imgextra/i1/O1CN01cG8ZE02192EvBEBSH_!!6000000006941-55-tps-24-24.svg)文本生成

###### [![Image 37: Fun-ASR](https://img.alicdn.com/imgextra/i4/O1CN01aF2Ya21gXfc0oMugD_!!6000000004152-55-tps-14-14.svg)Qwen3.8-Max _HOT_ 0902 快照版本重磅更新，智能体时代全能旗舰模型](https://platform.qianwenai.com/try-ai?models=qwen3.8-max-0902)###### [![Image 38: Fun-ASR](https://img.alicdn.com/imgextra/i4/O1CN01aF2Ya21gXfc0oMugD_!!6000000004152-55-tps-14-14.svg)Qwen3.8-Flash _NEW_ 百万级上下文窗口，一次性处理超长文档和代码仓库](https://platform.qianwenai.com/try-ai?models=qwen3.8-flash)###### [![Image 39: Fun-ASR](https://img.alicdn.com/imgextra/i4/O1CN01aF2Ya21gXfc0oMugD_!!6000000004152-55-tps-14-14.svg)Qwen3-VL-Plus 视觉 Coding、空间感知、多模态思考等全面升级](https://platform.qianwenai.com/try-ai?models=qwen3-vl-plus)

###### [![Image 40: Kimi-K3](https://img.alicdn.com/imgextra/i4/O1CN01zZ5N8O1FvUau58xvk_!!6000000000549-55-tps-14-14.svg)Kimi-K3 Kimi 最新旗舰模型，长程编程与推理利器](https://www.qianwenai.com/models/kimi%2Fkimi-k3)###### [![Image 41: Deepseek-v4-pro](https://img.alicdn.com/imgextra/i3/O1CN01gcs2521tgSDH7j5NC_!!6000000005931-55-tps-14-14.svg)Deepseek-v4-pro 旗舰 MoE 大模型，百万上下文与顶尖推理能力](https://platform.qianwenai.com/try-ai?models=deepseek-v4-pro)###### [![Image 42: GLM-5.2](https://img.alicdn.com/imgextra/i1/O1CN01vxXuZt1K85wuj07CP_!!6000000001118-55-tps-14-14.svg)GLM-5.2 1M上下文，专为长程任务能力而生](https://platform.qianwenai.com/try-ai?models=glm-5.2)

##### ![Image 43: 图片和视频生成](https://img.alicdn.com/imgextra/i4/O1CN011o40eW20rdBmYijum_!!6000000006903-55-tps-24-24.svg)图片和视频生成

###### [![Image 44: Fun-ASR](https://img.alicdn.com/imgextra/i4/O1CN01aF2Ya21gXfc0oMugD_!!6000000004152-55-tps-14-14.svg)Wan3.0-Video 四模态全能参考，多种创作一站支持](https://platform.qianwenai.com/try-ai?scene=video&models=wan3.0-video)###### [![Image 45: Fun-ASR](https://img.alicdn.com/imgextra/i4/O1CN01aF2Ya21gXfc0oMugD_!!6000000004152-55-tps-14-14.svg)Qwen-Image-3.0-Pro _NEW_ 细节真实，知识厚实，让图像生成真正成为可落地的生产力工具](https://platform.qianwenai.com/try-ai/chat?models=qwen-image-3.0-pro)###### [![Image 46: HappyHorse-1.1-T2V](https://img.alicdn.com/imgextra/i1/O1CN01kQsuEF1xljEn4gAbh_!!6000000006484-55-tps-14-14.svg)HappyHorse-1.1-T2V 让文字生成流畅细腻的高质量视频](https://platform.qianwenai.com/try-ai?models=happyhorse-1.1-t2v)

##### ![Image 47: 语音识别与合成](https://img.alicdn.com/imgextra/i2/O1CN01UBMw1L1d3x46Vr1q3_!!6000000003681-55-tps-24-24.svg)语音识别与合成

###### [![Image 48: Fun-ASR](https://img.alicdn.com/imgextra/i4/O1CN01aF2Ya21gXfc0oMugD_!!6000000004152-55-tps-14-14.svg)Qwen3-TTS-Flash 离线语音合成大模型，多语言方言自适应，低延迟高稳定](https://platform.qianwenai.com/try-ai?scene=tts&models=qwen3-tts-flash)###### [![Image 49: Fun-ASR](https://img.alicdn.com/imgextra/i4/O1CN01aF2Ya21gXfc0oMugD_!!6000000004152-55-tps-14-14.svg)Cosyvoice-V3-Flash 高表现力语音合成大模型，语音克隆听感自然](https://platform.qianwenai.com/try-ai?scene=tts&models=cosyvoice-v3-flash)###### [![Image 50: Fun-ASR](https://img.alicdn.com/imgextra/i4/O1CN01aF2Ya21gXfc0oMugD_!!6000000004152-55-tps-14-14.svg)Fun-ASR 支持中英文自由切换，具备更强的噪声鲁棒性](https://platform.qianwenai.com/try-ai?models=fun-asr)
...
[![Image 51: 阿里云 OPC 创新助力计划](https://img.alicdn.com/imgextra/i3/O1CN01vBbQLH1XUcOADg2M5_!!6000000002927-2-tps-460-544.png) ##### 阿里云 OPC 创新助力计划 至高可申请百万元 Token 补贴，五大权益加速 OPC 成功](https://opc.aliyun.com/)
...
4008013260[售前咨询](https://smartservice.console.aliyun.com/pre-sale/chat?entrance=201&referrer=https%3A%2F%2Fhelp.aliyun.com%2Fzh%2Fmodel-studio%2Fcoding-plan)[售后在线](https://smartservice.console.aliyun.com/service/robot-chat?entrance=201&referrer=https%3A%2F%2Fhelp.aliyun.com%2Fzh%2Fmodel-studio%2Fcoding-plan)
### 其他服务

[我要建议](https://www.aliyun.com/connect/home)[我要投诉](https://www.aliyun.com/complaint)

![Image 52: 登录插画](https://img.alicdn.com/imgextra/i2/O1CN015QIT9m1FmmyUntYlQ_!!6000000000530-2-tps-320-200.png)
登录以查看您的控制台资源
...
[快捷注册](https://account.aliyun.com/register/qr_register.htm?oauth_callback=https%3A%2F%2Fhelp.aliyun.com%2Fzh%2Fmodel-studio%2Fcoding-plan)[登录阿里云](https://account.aliyun.com/login/login.htm?oauth_callback=https%3A%2F%2Fhelp.aliyun.com%2Fzh%2Fmodel-studio%2Fcoding-plan)
