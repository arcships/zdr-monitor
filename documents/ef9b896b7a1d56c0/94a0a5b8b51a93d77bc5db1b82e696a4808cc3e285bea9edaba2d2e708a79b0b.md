...
Published Time: Wed, 08/03/2022 - 17:15
...
1.   **Deployment Model.**
    ...
    2.   **Shared Responsibility.** Databricks operates in a shared responsibility model, where both Databricks and Customer maintain security responsibilities. This is covered in more detail in our [Documentation](https://docs.databricks.com/aws/en).
    3.   **Data Storage.** Depending on your configuration and which Platform Services features a Customer accesses, Databricks may process Customer Content stored within Customer's own Cloud Service Provider account and/or within Databricks' infrastructure. See the [Documentation](https://docs.databricks.com/aws/en) for details.

2.   **Deployment Region.** Customer may choose where their Platform Services Workspaces are deployed from any Databricks-supported region(s), or where applicable, a collection of regions grouped by Databricks (“**Geo**”). Databricks will not, without Customer’s permission, move a Customer Workspace from the region or Geo chosen by Customer. See the [Documentation](https://docs.databricks.com/aws/en) for details.
