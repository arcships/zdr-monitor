...
URL Source: https://www.baseten.co/dpa/
...
**Baseten (Data Importer / Processor):** Baseten Labs, Inc., 560 Davis St., Suite 250, San Francisco, CA 94111. Contact: [privacy@baseten.co](mailto:privacy@baseten.co). Role: Processor.
...
**Duration / Retention:** For the period determined in accordance with the Agreement, this DPA, and the [Security Practices](https://www.baseten.co/security-practices), including any applicable Zero Data Retention posture and the thirty (30) day Post-Term Period.

### **Annex B: Security Measures**

The technical and organizational measures Baseten maintains to protect Customer Personal Data are the administrative, physical, and technical safeguards set forth in the Baseten Security Practices, available at [https://www.baseten.co/security-practices](https://www.baseten.co/security-practices), which are incorporated into this DPA by reference. The Security Practices include, among other things, Baseten's platform controls, access management, encryption in transit and at rest, product-specific data retention practices (including Zero Data Retention postures), incident management, business continuity, and personnel practices.
...
Questions about this DPA? Contact [privacy@baseten.co](mailto:privacy@baseten.co).
