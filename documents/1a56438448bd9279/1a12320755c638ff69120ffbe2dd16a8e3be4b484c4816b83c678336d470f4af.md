...
URL Source: https://docs.databricks.com/aws/en/machine-learning/foundation-model-apis/compliance
...
## Compliance standards support: Pay-per-token[​](https://docs.databricks.com/aws/en/machine-learning/foundation-model-apis/compliance#compliance-standards-support-pay-per-token "Direct link to Compliance standards support: Pay-per-token")
...
*   Additional compliance standards (PCI-DSS, FedRAMP, IRAP, CCCS, UK Cyber Essentials Plus) in supported regions.
    *   See [Compliance security profile](https://docs.databricks.com/aws/en/security/privacy/security-profile) for the available compliance standards. Each standard has its own page that lists the regions and features it supports.

*   Available for customers with the Compliance Security Profile enabled, including when a compliance standard is selected.

## Compliance standards support: Provisioned throughput[​](https://docs.databricks.com/aws/en/machine-learning/foundation-model-apis/compliance#compliance-standards-support-provisioned-throughput "Direct link to Compliance standards support: Provisioned throughput")
...
## [](https://docs.databricks.com/aws/en/machine-learning/foundation-model-apis/compliance) Data processing and residency[​](https://docs.databricks.com/aws/en/machine-learning/foundation-model-apis/compliance#-data-processing-and-residency "Direct link to -data-processing-and-residency")
...
## Regional model availability[​](https://docs.databricks.com/aws/en/machine-learning/foundation-model-apis/compliance#regional-model-availability "Direct link to Regional model availability")
...
| --- | --- | --- |
| US-only models | The following models are supported only in Foundation Model APIs pay-per-token supported US regions: * Anthropic Claude Opus 4.1 * Anthropic Claude Sonnet 5 * BGE Large (En) | For Anthropic Claude Sonnet 5, if your workspace is not in a US region but is in a supported Model Serving region, you can enable cross-Geo data processing to access this model. |
| EU and US models | The following models are available in [pay-per-token EU and US supported regions](https://docs.databricks.com/aws/en/resources/feature-region-support#model-serving-aws). * OpenAI GPT-6 Sol * OpenAI GPT-6 Luna * OpenAI GPT-6 Astra * OpenAI GPT-5.6 Sol * OpenAI GPT-5.6 Terra * OpenAI GPT-5.6 Luna * OpenAI GPT-5.5 Pro * OpenAI GPT-5.5 * OpenAI GPT-5.4 * OpenAI GPT-5.4 mini * OpenAI GPT-5.4 nano * OpenAI GPT-5.3 Codex * OpenAI GPT-5.2 * OpenAI GPT-5.1 * OpenAI GPT-5 * OpenAI GPT-5 mini * OpenAI GPT-5 nano * Anthropic Claude Fable 5.1 * Anthropic Claude Fable 5 * Anthropic Claude Opus 5 * Anthropic Claude Opus 4.8 * Anthropic Claude Opus 4.7 * Anthropic Claude Opus 4.6 * Anthropic Claude Opus 4.5 * Anthropic Claude Sonnet 4.6 * Anthropic Claude Sonnet 4.5 * Anthropic Claude Haiku 4.5 * Anthropic Claude Sonnet 4 | If your workspace is not in an EU or US region but is in a supported Model Serving region, you can enable cross-Geo data processing to access these models. |
...
## Security best practices[​](https://docs.databricks.com/aws/en/machine-learning/foundation-model-apis/compliance#security-best-practices "Direct link to Security best practices")
...
| Network security | * Endpoints respect IP allowlists and [PrivateLink](https://docs.databricks.com/aws/en/security/network/classic/privatelink) configurations. * You can restrict outbound network access from Model Serving endpoints by configuring network policies. * See [Manage network policies](https://docs.databricks.com/aws/en/security/network/serverless-network-security/manage-network-policies) for more information. |
...
## Additional resources[​](https://docs.databricks.com/aws/en/machine-learning/foundation-model-apis/compliance#additional-resources "Direct link to Additional resources")
