...
URL Source: https://modal.com/docs/guide/security

Published Time: Sat, 01 Jan 2000 00:00:00 GMT

Markdown Content:
The document outlines Modal’s security and privacy commitments.

## Application security (AppSec)[](https://modal.com/docs/guide/security#application-security-appsec)
...
## Corporate security (CorpSec)[](https://modal.com/docs/guide/security#corporate-security-corpsec)
...
## Network and infrastructure security (InfraSec)[](https://modal.com/docs/guide/security#network-and-infrastructure-security-infrasec)
...
### Severity timeframes[](https://modal.com/docs/guide/security#severity-timeframes)
...
## SOC 2[](https://modal.com/docs/guide/security#soc-2)

We have successfully completed a [System and Organization Controls (SOC) 2 Type 2 audit](https://modal.com/blog/soc2type2). Go to our [Security Portal](https://trust.modal.com/) to request access to the report.

## HIPAA[](https://modal.com/docs/guide/security#hipaa)
...
Modal uses [Stripe](https://stripe.com/) to securely process transactions and trusts their commitment to best-in-class security. We do not store personal credit card information for any of our customers. Stripe is certified as “PCI Service Provider Level 1”, which is the highest level of certification in the payments industry.

## Bug bounty program[](https://modal.com/docs/guide/security#bug-bounty-program)

Keeping user data secure is a top priority at Modal. We welcome contributions from the security community to identify vulnerabilities in our product and disclose them to us in a responsible manner. We currently run a private bug bounty program through HackerOne. If you have found a vulnerability and wish to participate, please send an email to [security@modal.com](mailto:security@modal.com) with your HackerOne username or email and we will invite you to the program.

## Data privacy[](https://modal.com/docs/guide/security#data-privacy)
...
### Data retention[](https://modal.com/docs/guide/security#data-retention)
...
| --- | --- | --- |
| Inputs and outputs | [Functions](https://modal.com/docs/guide) (`.remote`, `.spawn`, `.map`, [Web Functions](https://modal.com/docs/guide/webhooks), Scheduled Functions) | Up to 7 days, then deleted |
| Request and response payloads | [Server](https://modal.com/docs/guide/servers) and [Auto Endpoints](https://modal.com/docs/guide/endpoints) | Not stored — proxied directly to your container |
| App and container logs | [Functions](https://modal.com/docs/guide), [Sandboxes](https://modal.com/docs/guide/sandboxes) | Plan-dependent: 1 day on Starter, 30 days on Team, configurable on Enterprise (see [pricing](https://modal.com/pricing)) |
| Audit logs | Workspace (Enterprise) | Per Enterprise contract (see [Audit logs](https://modal.com/docs/guide/audit-logs)) |
| Files | [Volumes](https://modal.com/docs/guide/volumes), [Images](https://modal.com/docs/guide/images) | Persistent until you delete them |
| Memory snapshots | [Function memory snapshots](https://modal.com/docs/guide/memory-snapshots), [Sandbox memory snapshots](https://modal.com/docs/guide/sandbox-snapshots) | 7 days after creation |
| Filesystem snapshots | [Sandbox filesystem snapshots](https://modal.com/docs/guide/sandbox-snapshots) | 30 days after creation (configurable; stored as Images) |
| Directory snapshots | [Sandbox directory snapshots](https://modal.com/docs/guide/sandbox-snapshots) | 30 days after creation (configurable) |
| Entries | [Dicts](https://modal.com/docs/guide/dicts) | 7 days after last read or write |
| Partitions | [Queues](https://modal.com/docs/guide/queues) | Configurable per-partition TTL (default 24 hours) |
| App, Function, and container metadata | All products | Stored for the lifetime of your account |

#### Function inputs and outputs[](https://modal.com/docs/guide/security#function-inputs-and-outputs)
...
#### Modal Inference endpoints[](https://modal.com/docs/guide/security#modal-inference-endpoints)
...
## Questions?[](https://modal.com/docs/guide/security#questions)
