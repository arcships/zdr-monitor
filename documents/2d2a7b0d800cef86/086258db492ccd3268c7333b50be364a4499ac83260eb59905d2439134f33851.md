...
URL Source: https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy
...
## How to determine your authentication method[](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#how-to-determine-your-authentication-method)
...
| Alibaba Cloud Coding Plan | Alibaba Cloud | See [details below](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#2-if-you-are-using-alibaba-cloud-coding-plan) | See [details below](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#2-if-you-are-using-alibaba-cloud-coding-plan) |
...
## 1. If you are using Qwen OAuth Authentication[](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#1-if-you-are-using-qwen-oauth-authentication)
...
## 2. If you are using Alibaba Cloud Coding Plan[](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#2-if-you-are-using-alibaba-cloud-coding-plan)
...
## 3. If you are using your own API Key[](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#3-if-you-are-using-your-own-api-key)
...
## 4. If you are using Vertex AI[](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#4-if-you-are-using-vertex-ai)

When you authenticate with Google Cloud Vertex AI, the applicable Terms of Service and Privacy Notice are Google Cloud’s.

## Usage Statistics and Telemetry[](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#usage-statistics-and-telemetry)
...
### What Data is Collected[](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#what-data-is-collected)
...
### Data Collection by Authentication Method[](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#data-collection-by-authentication-method)
...
## Frequently Asked Questions (FAQ)[](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#frequently-asked-questions-faq)

### 1. Is my code, including prompts and answers, used to train AI models?[](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#1-is-my-code-including-prompts-and-answers-used-to-train-ai-models)
...
### 2. What are Usage Statistics and what does the opt-out control?[](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#2-what-are-usage-statistics-and-what-does-the-opt-out-control)
...
### 3. How do I switch between authentication methods?[](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy#3-how-do-i-switch-between-authentication-methods)
...
For detailed instructions, see the [Authentication Setup](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/auth/) documentation.
