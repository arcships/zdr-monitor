Title: Privacy Policy | OpenRouter

URL Source: https://openrouter.ai/privacy

Markdown Content:
[Skip to content](https://openrouter.ai/privacy#skip)
...
*   Information that you provide by using our Site or Service or by filling out forms on the Site. This includes information provided at the time of or after registering and creating an account, using our Service, sending Inputs through the Service, and using Shared User Content functionality. We may also ask you for information when you report a problem with our Site or Service.
*   Information that you provide to our third-party partners that integrate, interoperate with, or connect to the Site or Service.
...
*   Image, audio, video, and "biometric information". Certain Models available through our Service accept image, audio or video Inputs, or generate image, audio or video Outputs. If you submit image, audio or video files through the Service, including voice recordings and other depictions of identifiable individuals those files may contain personal data about you or others, that are considered "biometric information" under applicable laws.
*   Files you upload and store. If our Service offers a Files API or similar feature that lets you upload and persistently store files (such as images, PDFs, or other documents) for later use in inference requests, we collect and store those files and associated metadata (such as file name, type, size, and upload date) until you delete them or close your account, as described in "Files You Upload and Store (Files API)" below.
...
When you submit Inputs through the Service, those Inputs are transmitted to the Model Provider you select, or that is selected through automatic routing, as applicable. Different Model Providers have different data practices, including with respect to whether they retain or use your Inputs and Outputs to train, fine-tune, evaluate, or improve their Models. **Some Model Providers may use your Inputs and Outputs for model training or improvement.** Before using a Model, you should review the applicable Model Provider's data practices, which are linked [here](https://openrouter.ai/docs/features/provider-routing#terms-of-service). Where disclosed to us, we label Models that do not use your data for training. If you do not want your Inputs used for model training, select a Model or Model Provider that commits to not using your data for that purpose.

## Enterprise and API Users

If you have a Data Processing Agreement with us, the terms of that agreement and our separate agreements with Model Providers govern how your data is handled by each Model Provider, including any restrictions on model training.

**OpenRouter does not use your Inputs or Outputs for model training.**

## Biometric Data Processing

Some Models perform processing that may constitute biometric data processing under applicable law. This includes, but is not limited to:

*   Voice cloning: creating a synthetic replica of a speaker's voice from audio samples, which requires extracting unique vocal characteristics (a voiceprint).
*   Voice changer: transforming or altering a speaker's voice in real time, which involves analyzing unique vocal features.
*   Speaker identification: distinguishing or identifying individual speakers based on voice characteristics.
*   Voice-preserving audio translation: translating audio while retaining the acoustic and tonal characteristics of the original speaker's voice.
*   Face cloning: generating a digital replica of a person's face from a photograph, video or other sample, which requires extracting facial geometry that may constitute a faceprint.

When using these features, the Model Provider will process your audio or visual data to extract biometric identifiers, including without limitation voice prints, voice models, and face prints. This data is treated as biometric data under the EU and UK GDPR, as sensitive personal information under the CCPA, and as biometric identifiers under the Illinois Biometric Information Privacy Act ("BIPA") and similar state laws.

If you submit image, audio or video data containing the voice or image of another person to a Model that performs biometric processing, you are responsible for ensuring that you have obtained appropriate notice and consent from that individual as required by applicable law. You should not submit another person's voice or image data to a biometric processing feature without their informed consent. OpenRouter acts as an intermediary, passing source image, audio and visual data to Models, and does not independently process or store this biometric data, or generate any biometric identifiers.

## Cookies and Other Tracking Technology

We may use cookies, embedded scripts, and other similar tracking technologies ("**Tracking Technologies**") to collect additional personal data automatically as you interact with the Site and to personalize your experience with our Site. These technologies help us recognize you, customize or personalize your experience, market additional products or services to you, and analyze the use of our Service to make them safer and more useful to you. We also may use these technologies to collect information about your online activities over time and across third party websites or other online services (known as "behavioral tracking").
...
*   Transmitting your Inputs to third-party Model Providers for inference, and depending on the Model selected, for model training and improvement purposes.
...
*   Delivering interest-based ads (also known as personalized ads or targeted ads). We show you interest-based ads to display aspects of our Site and Services that might be of interest to you. We use cookies, pixels, IP addresses and other technologies ("**Advertising Technologies**"), which enable us to understand the effectiveness of the interest-based ads we show you by measuring what ads are clicked or viewed, and to provide you with more useful and relevant ads. We also work with third parties, such as advertisers, social media networks, search engines, ad serving companies, and advertising companies working on their behalf, to improve the relevance of ads we serve. In providing you interest-based ads we do not associate your interactions on unaffiliated sites with information which on its own identifies you, such as name or email address, and we do not provide any such information to advertisers or to third-party sites that display our interest-based ads. Third party advertisers or advertising companies working on their behalf sometimes use Advertising Technologies in the process of delivering content, including ads, directly to your browser or device, and they may automatically receive an IP address when this happens. They may also use advertising technologies to measure the effectiveness of their ads, show you more relevant advertising content, and perform services on our behalf.
...
To exercise your rights, you or your authorized agent may submit a request by email at [[email protected]](https://openrouter.ai/cdn-cgi/l/email-protection#9dedeff4ebfcfee4ddf2edf8f3eff2e8e9f8efb3fcf4). We may first request additional information to verify your identity before processing your request.
...
*   Sale and targeted marketing of our products and Services. We do not "sell" your personal data as that term is defined by applicable laws and regulations. You can opt out of sharing your personal data for targeted advertising by following the directions in this section.

Under the California Consumer Privacy Act ("CCPA"), you may exercise your right to opt out of "sharing" as defined in the CCPA by selecting Model Providers that do not use your personal data for training. OpenRouter cannot control Model Provider-side training once user data is transmitted to a training-permitted Model Provider.
...
Image, audio, and video data submitted through the Service is transmitted to the applicable Model Provider for inference. We do not persist image, audio or video files beyond the duration necessary to route the request, except as required for abuse detection, security, billing, or legal compliance. This paragraph describes our handling of image, audio, and video files submitted as Inputs to a Model. Files you separately upload and store using the Files API (or a similar persistent file-storage feature) are retained until you delete them, as described in "Files You Upload and Store (Files API)" below. Model Providers' retention practices vary; check the applicable provider's data practices. You may request deletion of your data by contacting us at [[email protected]](https://openrouter.ai/cdn-cgi/l/email-protection).

## Files You Upload and Store (Files API)

If our Service offers a Files API or similar feature, you may be able to upload, store, and retrieve files (such as images, PDFs, and other documents) for use in connection with inference requests ("**Uploaded Files**"). Unlike the ephemeral image, audio, and video Inputs described above, Uploaded Files are retained by us until you delete them or close your account, subject to the exceptions described below.

**How we use Uploaded Files.** We use Uploaded Files solely to (a) fulfill the inference request(s) you submit, including transmitting the file to the Model Provider you select; (b) operate, maintain, and secure the Service, including automated screening for prohibited content such as child sexual abuse material (CSAM) and malware; and (c) comply with our legal obligations. We do not use the content of Uploaded Files to train our own models, for analytics unrelated to operating the Service, or for marketing purposes.

**Sharing with Model Providers.** Uploaded Files submitted with an inference request are transmitted to the Model Provider(s) you select to process that request, in the same manner described in "With Model Providers" above. Each Model Provider processes Uploaded Files subject to its own data handling, retention, and use terms, which we encourage you to review.

**Storage, security, and access.** Uploaded Files are encrypted at rest and in transit. We restrict access to Uploaded Files to the automated systems necessary to operate the Service (such as content screening and transmission to Model Providers); our personnel do not access the content of Uploaded Files except as necessary to investigate a suspected violation of our Terms of Service, respond to legal process, or provide support at your request.

**Retention and deletion.** We retain Uploaded Files until you delete them or close your account. When you delete an Uploaded File or your account, we work to remove the file, including cached and replicated copies, from active systems and backups within the timeframes described in our Data Processing Agreement (where applicable) or as we otherwise publish, except where we are required to retain it for legal, security, or compliance purposes.

### 8. Eligibility

This Site is offered and available to users who are 18 years of age or older. By using the Site, you represent and warrant that you are at least 18 years old and that you are of legal age to form a binding contract with us. If you do not meet all of these requirements, you must not access or use our Site.

### 9. Data Transfers

When you access our Site or Service, your personal data may be transferred to our servers in the US, or to other countries outside the European Economic Area ("**EEA**") and the UK. This may be a direct provision of your personal data to us, or a transfer that we or a third party make. When information is transferred outside the EEA or UK, we ensure it benefits from an adequate legal protection by relying on (1) adequacy decisions from the European Commission under Article 45 of the European Union's General Data Protection Regulation (GDPR) where they recognize that a country outside of the EEA offers an adequate level of data protection, and (2) standard contractual clauses approved by the European Commission under Article 46 of the GDPR, which allows companies in the EEA to transfer data outside the EEA. Uploaded Files you store through the Files API are subject to the same data transfer safeguards described in this Section, and are also, when transmitted to a Model Provider with an inference request, subject to the transfer arrangements described in our Data Processing Agreement for that Model Provider.

### 10. Governing Law

All disputes arising out of or relating to the Privacy Policy or the purchase, registration, or use of any OpenRouter product or Service shall be governed by New York law regardless of where you access the Site or the Service, and notwithstanding any conflicts of law principles, except to the extent applicable privacy laws provide rights or obligations that cannot be waived or varied by contract.
...
| Categories of Personal Data | Use of Personal Data | Disclosure of Personal Data |
| --- | --- | --- |
| We collect the following information, as described above: * Identifiers, such as your name, contact details, IP address, and other device identifiers * Commercial information, such as your transaction history * Network activity information, such as how you interact with our Service * Communication information, such as your contact information when you send us email * Geolocation data, such as the general area from which your device accesses our Service based on information like its IP address, or precise location information you choose to provide * Your account credentials | We use this information for the following purposes, as described above: * Provide, analyze, and maintain our Service, and where applicable, for Model training and improvement by Model Providers. The legal basis is to perform a contract with you. * Improve and develop our Service and conduct research. The legal basis is a legitimate interest. * Communicate with you, including to send you information about our Service and events. The legal basis is your consent. * Prevent fraud, illegal activity, or misuses of our Service, and to protect the security of our systems and Service. The legal basis is legitimate interest and legal obligation. * Comply with legal obligations and protect the rights, privacy, safety, or property of our users, OpenRouter or third parties. The legal basis is legitimate interest and legal obligation. | We may disclose this information in the following circumstances, as described above: * Vendors, service providers, and affiliates to process in accordance with our instructions, including to Model Providers * Government authorities or other third parties for the legal reasons described above * Parties involved in corporate transactions * Other users and third parties you interact or share information with |
