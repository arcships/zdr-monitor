...
URL Source: https://zed.dev/docs/telemetry
...
## [Configuring Telemetry Settings](https://zed.dev/docs/telemetry#configuring-telemetry-settings)

You have full control over what data is sent out by Zed. To enable or disable some or all telemetry types, open Settings (ctrl-,) and search for “telemetry”, or add the following to your settings file:
...
## [Dataflow](https://zed.dev/docs/telemetry#dataflow)
...
## [Types of Telemetry](https://zed.dev/docs/telemetry#types-of-telemetry)

### [Diagnostics](https://zed.dev/docs/telemetry#diagnostics)
...
You can inspect what data is sent in the `CrashInfo` struct in [crates/crashes/src/crashes.rs](https://github.com/zed-industries/zed/blob/main/crates/crashes/src/crashes.rs). See also: [Debugging Crashes](https://zed.dev/docs/development/debugging-crashes.html).

### [Client-Side Metrics](https://zed.dev/docs/telemetry#client-side-metrics)
...
### [Server-Side Metrics](https://zed.dev/docs/telemetry#server-side-metrics)
...
For details on AI request paths and opt-in data sharing, see [AI Privacy](https://zed.dev/docs/ai/privacy-and-security.html) and [Feedback and Training Data](https://zed.dev/docs/ai/ai-improvement.html).

## [Zed Business](https://zed.dev/docs/telemetry#zed-business)

Administrators on Zed Business can enforce a no-sharing policy org-wide; members can’t opt into [Edit Prediction training data sharing](https://zed.dev/docs/ai/ai-improvement.html#edit-predictions) or [AI feedback ratings](https://zed.dev/docs/ai/ai-improvement.html#ai-feedback-with-ratings). See [Data Sharing](https://zed.dev/docs/business/admin-controls.html#data-sharing) in Admin Controls.

## [Concerns and Questions](https://zed.dev/docs/telemetry#concerns-and-questions)
