Title: Legal - Service Terms

URL Source: https://www.digitalocean.com/legal/tos-service-specific-terms

Markdown Content:
The Service Terms govern your use of and access to the Services. Capitalized terms used in these Service Terms but not defined below are defined in the Terms of Service Agreement published at [https://www.digitalocean.com/legal/terms-of-service-agreement](https://www.digitalocean.com/legal/terms-of-service-agreement) or other written agreement in effect between you (referred to from time to time as a “Customer” for purposes of these Service Terms) and us (referred to from time to time as DigitalOcean) governing use of and access to the Services (the “Agreement”).

### **1. Universal Service Terms (Applicable to All Services).**[](https://www.digitalocean.com/legal/tos-service-specific-terms#1-universal-service-terms-applicable-to-all-services)
...
1.2 Service Level Commitments. Certain Service Terms include applicable service level agreements available at [https://www.digitalocean.com/sla](https://www.digitalocean.com/sla) (each, an “SLA”). Each SLA applies solely to the Services identified therein, is subject to the terms, conditions, limitations, and restrictions specified in such SLA, and is incorporated into and forms part of the Agreement. Service Credits provided for under applicable SLAs are Customer’s sole and exclusive remedy with respect to DigitalOcean’s failure to meet the Service Commitment under the applicable SLA.
...
1.3.2 You must comply with current technical product documentation applicable to the Services available at [https://docs.digitalocean.com/](https://docs.digitalocean.com/) (and any successor or related locations designated by us).
...
### **2. DigitalOcean Gradient™ AI Platform Service and Playground Feature**[](https://www.digitalocean.com/legal/tos-service-specific-terms#2-digitalocean-gradient-ai-platform-service-and-playground-feature)
...
2.3 Attribution. For information about the Gradient AI Platform Service and Playground open source attribution notice, please click here: [Gen AI Platform Service - Attribution Notice File](https://digitalocean-legal.nyc3.cdn.digitaloceanspaces.com/Gen%20AI%20Platform%20Service%20-%20Attribution%20Notice%20File%20(1).pdf).
...
### **3. Cloudways Services**[](https://www.digitalocean.com/legal/tos-service-specific-terms#3-cloudways-services)
...
4.3.1 Black-forest-labs FLUX.1-schnell (provided by [Fal.ai](http://fal.ai/)): This AI Model is provided by [Fal.ai](http://fal.ai/), as a subprocessor to the Service. (Last Updated: March 2026)

4.3.2 Elevenlabs TTS Multilingual v2: This AI Model is provided by [Fal.ai](http://fal.ai/), as a subprocessor to the Service. (Last Updated: March 2026)

4.3.3 Stability AI SD-XL 1.0 (Fast SDXL) and Stable Audio 2.5 (Test-to-Audio): This AI Model is provided by [Fal.ai](http://fal.ai/), as a subprocessor to the Service. (Last Updated: March 2026)

4.3.4. Plano-Orchestrator-30B-A3B: This Model is subject to the [Katanemo Community License Agreement](https://huggingface.co/katanemo/Plano-Orchestrator-30B-A3B/blob/main/LICENSE).
...
### **5. Batch Inferencing**[](https://www.digitalocean.com/legal/tos-service-specific-terms#5-batch-inferencing)
...
### **6. Launchpad**[](https://www.digitalocean.com/legal/tos-service-specific-terms#6-launchpad)
...
### **7. Evaluations**[](https://www.digitalocean.com/legal/tos-service-specific-terms#7-evaluations)
...
7.3.2 Data Sensitivity. You are responsible for ensuring your Evaluation Datasets are de-identified and do not contain sensitive data or personally identifiable information, unless your use is expressly governed by the [Data Processing Agreement](https://www.digitalocean.com/legal/data-processing-agreement) and the applicable Service tier supports such data.

7.3.3 Third-Party Models. Your use of third-party models is subject to [https://www.digitalocean.com/legal/third-party-ai-models](https://www.digitalocean.com/legal/third-party-ai-models) and any applicable third-party license terms, which you are responsible for following. Where applicable, DigitalOcean may share usage metadata (excluding your Services Content) with the relevant model provider for billing or abuse-detection purposes.
...
### **8. Managed Databases**[](https://www.digitalocean.com/legal/tos-service-specific-terms#8-managed-databases)
...
8.1 Service Level Agreement. The DigitalOcean Databases SLA is available at [https://www.digitalocean.com/sla/databases](https://www.digitalocean.com/sla/databases) (the “Databases SLA”). As provided in Section 1.2, Service Credits under the Databases SLA are Customer’s sole and exclusive remedy for any failure to meet the applicable Service Commitment.
