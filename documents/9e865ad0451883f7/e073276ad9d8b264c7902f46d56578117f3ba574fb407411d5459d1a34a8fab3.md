Title: Privacy and data | Cursor Docs

URL Source: https://cursor.com/help/security-and-privacy/privacy

Markdown Content:
Cursor is designed to keep your code private. Here's how data handling works.

## [What is Privacy Mode?](https://cursor.com/help/security-and-privacy/privacy#what-is-privacy-mode)
...
## [How do I enable Privacy Mode?](https://cursor.com/help/security-and-privacy/privacy#how-do-i-enable-privacy-mode)

1.   Open Cursor Settings: 
    *   **Mac**: Press Cmd Ctrl + Shift + J
...
## [What data is sent to AI providers?](https://cursor.com/help/security-and-privacy/privacy#what-data-is-sent-to-ai-providers)
...
## [Where is my code processed?](https://cursor.com/help/security-and-privacy/privacy#where-is-my-code-processed)
...
## [Is my code used for training?](https://cursor.com/help/security-and-privacy/privacy#is-my-code-used-for-training)
...
## [Does Privacy Mode apply to Grok 4.5?](https://cursor.com/help/security-and-privacy/privacy#does-privacy-mode-apply-to-grok-45)

Yes. Privacy Mode works the same for [Grok 4.5](https://cursor.com/help/models-and-usage/grok-4-5) as for every other model. With Privacy Mode enabled, your code is never used for training.
...
## [Does Privacy Mode prevent xAI from training on my Grok Bot data?](https://cursor.com/help/security-and-privacy/privacy#does-privacy-mode-prevent-xai-from-training-on-my-grok-bot-data)
...
## [Where is Grok Bot computer data stored, how long is it kept, and how do I delete it?](https://cursor.com/help/security-and-privacy/privacy#where-is-grok-bot-computer-data-stored-how-long-is-it-kept-and-how-do-i-delete-it)
...
To request deletion of files that contain personal data, [contact support](https://cursor.com/help) with your account email, the agent name, and a description of the files. This follows the same data-deletion process as the rest of Cursor; see [How your data is used](https://cursor.com/data-use).

## [Are there exceptions to zero data retention?](https://cursor.com/help/security-and-privacy/privacy#are-there-exceptions-to-zero-data-retention)

ZDR doesn't apply when you use your own API keys. In that case, your data handling follows your provider's privacy policy.

Some models also require data retention with their provider and fall outside Cursor's ZDR agreements. These models are off by default and require admin approval before use. See [Models with data retention](https://cursor.com/docs/enterprise/privacy-and-data-governance#models-with-data-retention) for details.

## [What privacy controls are available for enterprise?](https://cursor.com/help/security-and-privacy/privacy#what-privacy-controls-are-available-for-enterprise)
...
*   **Compliance certifications**: SOC 2 Type II and more (see [Security and compliance documents](https://cursor.com/help/security-and-privacy/compliance))
...
## [What data stays on my machine vs. in Cursor's cloud with Self-Hosted Machines?](https://cursor.com/help/security-and-privacy/privacy#what-data-stays-on-my-machine-vs-in-cursors-cloud-with-self-hosted-machines)

With [Self-Hosted Machines](https://cursor.com/help/ai-features/self-hosted-machines), tool execution stays on your machine and the agent loop stays in Cursor's cloud. [Privacy Mode](https://cursor.com/data-use) applies the same way it does for managed Cloud Agents.

See [Self-Hosted Machines](https://cursor.com/help/ai-features/self-hosted-machines#what-data-stays-on-my-machine-vs-in-cursors-cloud) for the full data split.
...
*   [API keys](https://cursor.com/help/models-and-usage/api-keys)
