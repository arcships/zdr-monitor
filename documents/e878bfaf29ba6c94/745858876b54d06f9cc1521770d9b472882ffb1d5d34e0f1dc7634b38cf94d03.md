Title: FriendliAI - Privacy Policy

URL Source: https://friendli.ai/privacypolicy

Markdown Content:
**Effective Date: Sep 11, 2025**

[1. Introduction](https://friendli.ai/privacypolicy#1-introduction)  
[2. Scope](https://friendli.ai/privacypolicy#2-scope)  
[3. What Information We Collect](https://friendli.ai/privacypolicy#3-what-information-we-collect)  
[4. Use of Cookies and other Tracking Technologies](https://friendli.ai/privacypolicy#4-use-of-cookies-and-other-tracking-technologies)  
[5. Why We Collect Information](https://friendli.ai/privacypolicy#5-why-we-collect-information)  
[6. When We Disclose Information](https://friendli.ai/privacypolicy#6-when-we-disclose-information)  
[7. Automated Decision Making](https://friendli.ai/privacypolicy#7-automated-decision-making)  
[8. Retention of Personal Information](https://friendli.ai/privacypolicy#8-retention-of-personal-information)  
[9. Your Choices About the Information We Collect](https://friendli.ai/privacypolicy#9-your-choices-about-the-information-we-collect)  
[10. Children’s Privacy](https://friendli.ai/privacypolicy#10-childrens-privacy)  
[11. Visitors to the Site Outside of the United States](https://friendli.ai/privacypolicy#11-visitors-to-the-site-outside-of-the-united-states)  
[12. Links](https://friendli.ai/privacypolicy#12-links)  
[13. Security](https://friendli.ai/privacypolicy#13-security)  
[14. Your California Privacy Rights](https://friendli.ai/privacypolicy#14-your-california-privacy-rights)  
[15. Your Privacy Rights under Other US State Laws](https://friendli.ai/privacypolicy#15-your-privacy-rights-under-other-us-state-laws)  
[16. Your Rights Under the General Data Protection Regulation](https://friendli.ai/privacypolicy#16-your-rights-under-the-general-data-protection-regulation)  
[17. Your Rights Under the UK GDPR](https://friendli.ai/privacypolicy#17-your-rights-under-the-uk-gdpr)  
[18. Changes to This Privacy Policy](https://friendli.ai/privacypolicy#18-changes-to-this-privacy-policy)  
[19. Contact Us](https://friendli.ai/privacypolicy#19-contact-us)

**ANNEX 1: ADDITIONAL CLAUSES FOR KOREAN RESIDENTS**

[1. Personal Data Retention Period](https://friendli.ai/privacypolicy#1-personal-data-retention-period)  
[2. Consignment of Personal Data Processing](https://friendli.ai/privacypolicy#2-consignment-of-personal-data-processing)  
[3. Destruction of Personal Data](https://friendli.ai/privacypolicy#3-destruction-of-personal-data)  
[4. The Chief Privacy Officer and Staff Responsible for Privacy Inquiries](https://friendli.ai/privacypolicy#4-the-chief-privacy-officer-and-staff-responsible-for-privacy-inquiries)  
[5. Complaint to the Data Protection Authority](https://friendli.ai/privacypolicy#5-complaint-to-the-data-protection-authority)
...
By using our Sites or otherwise using our Services, you acknowledge this Policy and agree to our [**Terms of Service**](https://friendli.ai/terms-of-service) (“**Terms**”).
...
We use Google Analytics to help us understand how our customers use the Site. [Read more about how Google uses your Personal Information](https://policies.google.com/privacy?hl=en) or [opt-out of Google Analytics](https://tools.google.com/dlpage/gaoptout).
...
*   [Apple Safari](http://support.apple.com/kb/ph17191)
...
Note that if you turn cookies off, you may be unable to access certain parts or benefit from the full functionality of the Sites. To learn more about cookies and similar technologies or to opt-out of targeted advertising cookies, visit resources from the [Digital Advertising Alliance](http://www.aboutads.info/choices) (“**DAA**”) or the [Network Advertising Initiative](http://www.networkadvertising.org/choices) (“**NAI**”). We do not control these opt-out links or whether any organization chooses to participate in these opt-out programs.
...
Do Not Track (“**DNT**”) is a web browser setting that requests that a web application disable its tracking of an individual user. When you choose to turn on the DNT setting in your browser, your browser sends a special signal to websites, analytics companies, ad networks, plug in providers, and other web services you encounter while browsing to stop tracking your activity. Various third parties are developing or have developed signals or other mechanisms for the expression of consumer choice regarding the collection of information about an individual consumer’s online activities over time and across third-party websites or online services (_e.g._, browser do not track signals), but there is no universally agreed upon standard for what an organization should do when it detects a DNT signal. Currently, we do not monitor or take any action with respect to these signals or other mechanisms. You can learn more about Do Not Track [here](https://allaboutdnt.com/).
...
Information related to how long we retain each category of Personal Information is included in the [Retention of Personal Information](https://friendli.ai/privacypolicy#8-retention-of-personal-information) section above.
...
**Email Address**: [privacy@friendli.ai](mailto:privacy@friendli.ai)
...
| --- | --- | --- | --- | --- | --- |
| Amazon Web Services, Inc. ([aws-korea-privacy@amazon.com](mailto:aws-korea-privacy@amazon.com)) | U.S. | Transferred through server | Any personal data processed | Data management | Until member’s membership withdrawal; or until the consignment agreement is terminated |
| Oracle Corporation ([https://www.oracle.com/legal/data-privacy-inquiry-form](https://www.oracle.com/legal/data-privacy-inquiry-form)) | U.S. | Transferred through server | Any personal data processed | Data management | Until member’s membership withdrawal; or until the consignment agreement is terminated |
| Stripe, Inc. ([privacy@stripe.com](mailto:privacy@stripe.com)) | U.S. | Transferred through server | Name, email, billing address, credit card information, purchase amount, date of purchase | Electronic payment processing | Until member’s membership withdrawal; or until the consignment agreement is terminated |
| WorkOS, Inc. ([support@workos.com](mailto:support@workos.com)) | U.S. | Transferred through server | Name, email, organization name, authentication and identity provider information, login data | Authentication and Identity Management | Until member’s membership withdrawal; or until the consignment agreement is terminated |
| Google LLC ([googlekrsupport@google.com](mailto:googlekrsupport@google.com)) | U.S. | Transferred through server when Service usage history occurs | Service usage history | Analysis of usage patterns | Until member’s membership withdrawal; or until the consignment agreement is terminated |
| Amplitude, Inc. ([privacy@amplitude.com](mailto:privacy@amplitude.com)) | U.S. | Transferred through server when Service usage history occurs | Service usage history | Analysis of usage patterns | Until member’s membership withdrawal; or until the consignment agreement is terminated |
| Microsoft Clarity ([clarity@microsoft.com](mailto:clarity@microsoft.com)) | U.S. | Transferred through server when Service usage history occurs | Service usage history | Analysis of usage patterns | Until member’s membership withdrawal; or until the consignment agreement is terminated |
| HubSpot, Inc. ([privacy@hubspot.com](mailto:privacy@hubspot.com)) | U.S. | Transferred through server when Service usage history occurs | Service usage history | Analysis of usage patterns | Until member’s membership withdrawal; or until the consignment agreement is terminated |
| Twilio, Inc. ([privacy@twilio.com](mailto:privacy@twilio.com)) | U.S. | Transferred through server when sending emails | Email address | Sending email | Until member’s membership withdrawal; or until the consignment agreement is terminated |
...
| Functional Software, Inc. ([compliance@sentry.io](mailto:compliance@sentry.io)) | U.S. | Transferred through server during error monitoring and performance tracking | No personal data collected; only error logs and performance metadata (such as stack traces, timestamps, request paths without identifiers) | Application error monitoring and performance tracking | Until member’s membership withdrawal; or until the consignment agreement is terminated |
| Cloudflare, Inc. ([dpo@cloudflare.com](mailto:dpo@cloudflare.com)) | U.S. | Transferred through server during bot detection | IP address, user agent, request metadata used for bot detection | Bot detection (automated traffic identification) and security | Until member’s membership withdrawal; or until the consignment agreement is terminated |
...
| --- | --- |
| Name: Byung Gon Chun Title: Director | Department: Legal Phone number: +1(650)563 5047 Email address: [privacy@friendli.ai](mailto:privacy@friendli.ai) Contact Person: Elizabeth Yoon |
...
Personal Data Breach Reporting Center: 118 ([www.privacy.kisa.or.kr](http://www.privacy.kisa.or.kr/));

Personal Data Dispute Mediation Committee: 1833-6972 ([www.kopico.go.kr](http://www.kopico.go.kr/));

Cybercrime Investigation Division at the Supreme Prosecutors’ Office: 02-3480-3573 ([www.spo.go.kr](http://www.spo.go.kr/));

Cybercrime Investigation Bureau at the National Police Agency: 182 ([http://cyberbureau.police.go.kr](http://cyberbureau.police.go.kr/)).
