Title: Cody Context - Sourcegraph docs

URL Source: https://sourcegraph.com/docs/cody/core-concepts/context
...
## [Why is context important?](https://sourcegraph.com/docs/cody/core-concepts/context#why-is-context-important)

Context and [methods of retrieving context](https://sourcegraph.com/docs/cody/core-concepts/context#context-sources) are crucial to the quality and accuracy of AI. Cody relies on its ability to retrieve context from user codebases to provide reliable and accurate answers to developers’ questions. When Cody has access to the most relevant context about your codebase, it can:
...
## [Context sources](https://sourcegraph.com/docs/cody/core-concepts/context#context-sources)
...
## [Cody context fetching features](https://sourcegraph.com/docs/cody/core-concepts/context#cody-context-fetching-features)
...
## [Repo-based context](https://sourcegraph.com/docs/cody/core-concepts/context#repo-based-context)
...
## [How does context work with Cody prompts?](https://sourcegraph.com/docs/cody/core-concepts/context#how-does-context-work-with-cody-prompts)
...
*   **Prefix**: An optional description of the desired output, often derived from predefined [Prompts](https://sourcegraph.com/docs/cody/capabilities/prompts) that specify tasks the LLM can perform
...
## [Impact of context LLM vs Cody](https://sourcegraph.com/docs/cody/core-concepts/context#impact-of-context-llm-vs-cody)
...
## [Manage Cody context window size](https://sourcegraph.com/docs/cody/core-concepts/context#manage-cody-context-window-size)

While Cody aims to provide maximum context for each prompt, there are limits to ensure efficiency. For more details, see our [docs on token limits](https://sourcegraph.com/docs/cody/core-concepts/token-limits).
