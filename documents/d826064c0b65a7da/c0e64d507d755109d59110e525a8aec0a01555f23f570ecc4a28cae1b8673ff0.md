...
URL Source: https://opencode.ai/docs/enterprise/
...
2.   **[Contact us](https://opencode.ai/enterprise)** to discuss pricing and implementation options.
...
We use a per-seat model for OpenCode Enterprise. If you have your own LLM gateway, we do not charge for tokens used. For further details about pricing and implementation options, **[contact us](https://opencode.ai/enterprise)**.

* * *

## [Deployment](https://opencode.ai/docs/enterprise/#deployment)

Once you have completed your trial and you are ready to use OpenCode at your organization, you can **[contact us](https://opencode.ai/enterprise)** to discuss pricing and implementation options.
...
This is currently on our roadmap. If you’re interested, **[let us know](https://opencode.ai/enterprise)**.
...
Then **[contact us](https://opencode.ai/enterprise)** to discuss pricing and implementation options.

How does enterprise pricing work?
We offer per-seat enterprise pricing. If you have your own LLM gateway, we do not charge for tokens used. For further details, **[contact us](https://opencode.ai/enterprise)** for a custom quote based on your organization’s needs.
