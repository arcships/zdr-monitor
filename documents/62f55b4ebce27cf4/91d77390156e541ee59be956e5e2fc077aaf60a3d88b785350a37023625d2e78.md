...
URL Source: https://x.ai/build

Markdown Content:
## Bring Grok to  
your computer.

A powerful coding agent for complex work, now powered by Grok 4.6, our newest model.
...
Install now and start building with Grok 4.6 in Grok Build.
