...
*   **Personal Edition**: Designed for individual developers, it offers four plan tiers: Lite, Essential, Standard, and Pro, with a 7-day Credits limit. Higher tiers provide larger quotas.
...
| **7-day quota** | 2,500 Credits | 5,625 Credits | 10,000 Credits | 40,000 Credits | Unlimited |
...
When a quota limit is reached, the service is paused until the corresponding window period ends and the quota resets. Unused quota within a window period does not carry over to the next cycle. You can purchase Extra Bundles for additional capacity not subject to window limits, or wait for the window to expire.
