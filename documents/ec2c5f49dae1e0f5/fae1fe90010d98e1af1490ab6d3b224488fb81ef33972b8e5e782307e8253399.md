...
URL Source: https://www.jetbrains.com/legal/docs/privacy/privacy/
...
Version 3.2, last updated: 12 June 2026
...
c) **To improve our offerings based on usage.** With your consent, we may collect anonymous or aggregated data based on your use of JetBrains Products, unless the [Product Data Collection and Usage Notice](https://www.jetbrains.com/legal/docs/terms/product_data_collection/) states otherwise. We use this data to better understand the usage patterns of our products and the behaviors of our collective audience. At times, we may share anonymized information with third parties. Since the data is anonymous, no personal data is processed. Please refer to our [Cookie Notice](https://www.jetbrains.com/legal/docs/privacy/cookie-notice/) for more information regarding the collection of non-anonymous data (cookies) when you are using the JetBrains Website.
...
*   **Cookies (and other technologies).** For more information regarding cookies and other tracking technologies on our Website, please refer to our [Cookie Notice](https://www.jetbrains.com/legal/docs/privacy/cookie-notice/). For tracking in products, please refer to our [Product Data Collection and Usage Notice](https://www.jetbrains.com/legal/docs/terms/product_data_collection/). For more details on tracking in Website-based Products, please visit [this link](https://www.jetbrains.com/legal/docs/terms/website_products_cookie/).
...
*   **Social media platforms**. Our products and services may contain buttons for social media platforms, such as Facebook, Instagram, and X, and these buttons might include widgets such as the “Share This” button or other interactive mini-programs. These features may collect personal information such as your IP address, and they may set a cookie to enable them to function properly. Your interactions with these platforms are governed by the privacy policies of the companies providing them.
...
**Fonts.** Our website uses fonts (e.g. [_Google Fonts_](https://developers.google.com/fonts/faq/privacy)_, [Font Awesome](https://fontawesome.com/privacy)_). When you access our website, your browser may download these fonts from the font provider. This process may result in the transmission of your IP address and browser data to those providers. The use of these services is based on our legitimate interest in ensuring a uniform and efficient presentation of our online content (Article 6(1)(f) GDPR). You can prevent the use of web fonts by configuring your browser to block external resources, though this may affect display quality.
...
As permitted by applicable law, you may have the right to request a copy of the information that we hold about you. To submit a privacy request, please use our [Data Rights Request Form](https://privacyportal-de.onetrust.com/webform/6434b9ac-2aa5-43c8-b175-8cf8698591ad/65a79c35-b96c-40ae-9c11-57fb1de33764)**.**Where permitted by applicable law, we may charge a fee for this service.
...
These rights can be exercised by submitting a request through our **[Data Rights Request Form](https://privacyportal-de.onetrust.com/webform/6434b9ac-2aa5-43c8-b175-8cf8698591ad/65a79c35-b96c-40ae-9c11-57fb1de33764).**
...
| --- | --- |
| **Identifiers:** Name, signature, address, unique personal identifier, online identifier, Internet Protocol address, and telephone number.Note: Some personal information included in this category may overlap with other categories. | Business partners Affiliates Data analytics providers Advertising networks Advisors and agents Others as required by law |
| **Customer records:** Name, contact information, and financial or payment information (e.g. bank account number). | Business partners Affiliates Advisors and agents Others as required by law |
| **Commercial information:** Records of personal property, products or services purchased, obtained, or considered, or other purchasing or consuming histories or tendencies. | Business partners Affiliates Data analytics providers Advertising networks Advisors and agents Others as required by law |
| **Internet or other electronic network activity:** Browsing history, search history, and information on a consumer’s interaction with an internet website, application, or advertisement. | Business partners Affiliates Data analytics providers Advertising networks Advisors and agents Others as required by law |
| **Location data:** Physical location based on IP address and physical address. | Business partners Data analytics providers Advertising networks Advisors and agents Others as required by law |
| **Inferences drawn from other personal information to create a profile about a consumer:** Profile reflecting a consumer’s preferences, characteristics, psychological trends, predispositions, behavior, attitudes, intelligence, abilities, and aptitudes. | Business partners Data analytics providers Advertising networks Advisors and agents Others as required by law |
...
**Right to Know, Delete, and Correct.** California residents may submit CCPA requests to access/know, delete, or correct their personal information by sending an email to [privacy@jetbrains.com](mailto:privacy@jetbrains.com).
...
Residents of certain U.S. states, including Colorado, Connecticut, Utah, and Virginia, require additional disclosures under applicable privacy laws.
