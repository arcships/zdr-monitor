Title: Oracle Cloud Hosting and Delivery Policies

URL Source: https://www.oracle.com/contracts/docs/ocloud_hosting_delivery_policies_3089853.pdf

Published Time: Thu, 03 Sep 2026 00:37:10 GMT
...
Oracle Cloud Hosting and Delivery Policies Page 1 of 19 TABLE OF CONTENTS 
...
References in these Delivery Policies to a Cloud Services’ “Data Center Region” refer to (i) the geographic region listed in Your order for such Services or, (ii) if applicable, the country or larger geographic region which pertains to the data center location that You have selected when activating the instance of such Services. For purposes of the Data Center Region applicable to Your ordered Cloud Services, the following applies: 
...
Your order or Oracle’s Service Specifications (as defined in Your agreement for Oracle Cloud Services which includes Oracle Cloud Services Pillar documentation, Service Descriptions and additional definitions provided in the Oracle Cloud Services Agreement) may include additional details or exceptions related to specific Oracle Cloud Services. The Oracle Cloud Service Pillar documentation, the Service Descriptions and the Program Documentation for Oracle Cloud Services are available at 

www.oracle.com/contracts .

You agree to undertake any actions requested by Oracle and to otherwise provide Oracle with the information, access and cooperation reasonably necessary for Oracle to implement and maintain the Oracle Cloud Services, which includes Oracle's implementation of any changes to the Oracle Cloud Services as set forth in the Oracle Cloud Change Management Policy section . 
...
Oracle Cloud Services operate under practices which are aligned with the ISO/IEC 27002 Information security controls, from which a comprehensive set of controls are selected. Oracle Cloud Services are aligned with National Institute of Standards and Technology (“NIST”) 800-53 and 800-171. 
...
Oracle employs measures designed to prevent unauthorized persons from gaining access to Oracle-managed computing facilities in which Your Content is hosted, such as the use of security personnel, secured buildings, and designated data center premises. Oracle-managed office locations and cloud infrastructure facilities are secured. Oracle also requires its suppliers to similarly secure facilities hosting Your Content. Common controls between office locations and Oracle controlled co-locations/data centers currently include, for example: 

• Physical access requires authorization and is monitored 

• All employees, subcontractors and authorized visitors must visibly wear official identification while onsite 
...
Oracle policies require the use of multi-factor authentication (MFA), documented authorization controls, and logging of access. Use of MFA is mandatory for all Users accessing Oracle Cloud Services. When available for an Oracle Cloud Service, You must enable and enforce the Oracle provided option for MFA. If You use a third-party identity provider with an Oracle Cloud Service, You must configure it to require MFA for all Users accessing such Cloud Services. You are solely responsible for any negative consequences to You or Your Users related to Your Cloud Services that could have been avoided by use of the Oracle-provided MFA option, where available.  

> Oracle Cloud Hosting and Delivery Policies Page 6 of 19

All remote access to the Oracle Cloud Network by Oracle personnel that have access to Your Content is restricted through the use of a Virtual Private Network that utilizes MFA. In addition to the required use of a Virtual Private Network, before Oracle personnel are granted access to the Oracle Cloud Network, Oracle performs device posture checks and has in place controls, such as bastion hosts. Oracle prohibits (through both policy and technical controls) the use of personal devices to access the Oracle Cloud Network and the Oracle Cloud Services. 
...
Oracle follows formal procedures for tracking, managing, protecting and retiring assets. These responsibilities may include reviewing and authorizing access requests to those who have a business need and maintaining an inventory of assets. 

You are responsible for the assets You control that utilize or integrate with the Oracle Cloud Services, including determining the appropriate information classification for Your Content, and whether the documented controls provided by Oracle Cloud Services are appropriate for Your Content. 
...
During the Services Period, You may obtain the then-current Service Organization Control (SOC) report(s) by the methods made available to You (e.g., self-service console or Service Request (SR)), to the extent such reports are maintained for the in-scope Cloud Services. Such reports include a review  

> Oracle Cloud Hosting and Delivery Policies Page 8 of 19

of the controls in place and may consist of SOC 1 and/or SOC 2 reports. You agree that You will protect Oracle's SOC Reports, and all information contained therein, as Oracle's Confidential Information in accordance with the terms of the nondisclosure provision(s) of Your Agreement. You further acknowledge and agree that (1) You will use the SOC Reports only to evaluate Oracle's security controls; (2) the SOC Reports are provided without any warranty; and (3) Oracle retains all rights in and to the SOC Reports. 

1.13  Oracle Software Security Assurance 

Oracle Software Security Assurance (OSSA) is Oracle's methodology for building security into the design, build, testing, and maintenance of its products, whether they are used on-premises by customers, or delivered through Oracle Cloud. The OSSA program is described at 

https://www.oracle.com/corporate/security-practices/assurance/ .

1.14  Security Logs 

Oracle logs certain security-related activities on operating systems, applications, databases and network devices. Systems are configured to log default security activities, access to information or programs, system events such as alerts, console messages, and system errors. 

Oracle reviews logs for security event investigation and forensic purposes. Identified anomalous activities feed into the security event management process. Security logs are stored within the Security Information and Event Management system (or equivalent system) in a native, unaltered format and retained in accordance with Oracle's internal policies. Security logs are retained online for a minimum of 1 year. These logs are retained and used by Oracle for our internal security operations. 

1.15  Other Customer Security Related Obligations 

You are responsible for: 

• Implementing Your own comprehensive system of security, operational policies, standards and procedures 

• Performing integrity and security checks, such as scanning for vulnerabilities, viruses, malware and other malicious indicators of (i) Your data and files, prior to importing or uploading them into the Oracle Cloud Services; (ii) Your Content, for Oracle Cloud Services which enable You to configure Your security posture; and (iii) Your customizations and integrations 
...
o Security controls and network monitoring to reduce the risk of events which could threaten data confidentiality, availability or integrity  
...
Oracle will at all times maintain a plan as it pertains to Oracle’s internal operations with the goal of minimizing any disruption to the Services if any disaster, disruption or force majeure event occurs (“BC Plan”). 

The BC Plan establishes, documents and implements processes, procedures and controls to ensure Oracle business processes supporting Oracle Cloud Services are not diminished in the event the BC Plan is invoked. The purpose of the BC Plan is to provide resilience for Oracle’s internal operations for the continuity of the Oracle Cloud Services regardless of cause. 
...
“Unplanned Downtime” means any time when a problem with the applicable Oracle Cloud Services prevents Your connectivity to Your production instance of such Cloud Services. Unplanned Downtime does not include any time during which the Oracle Cloud Services or any Oracle Cloud Services components are not available due to: (i) scheduled maintenance periods, (ii) circumstances/infrastructure outside of Oracle’s control and other force majeure events, (iii) any actions or inactions of You, Your Users or any third party (other than any Oracle agents and contractors that Oracle has engaged to support the Services) or (iv) any permitted suspension by Oracle. 

In addition, with respect to Oracle Cloud at Customer Services, Unplanned Downtime also does not include downtime or other unavailability (i) of Your data center (e.g., due to maintenance) or (ii) occurring outside the on-site hours defined under Your order for Oracle Cloud Operations personnel at Your data center. 

3.4  Monitoring 

Oracle uses a variety of software tools to monitor the availability and performance of the Cloud Services and the operation of infrastructure and network components (such as CPU, memory, storage, database and other components). Oracle generates alerts associated with deviations to defined thresholds, and Oracle staff investigates and resolves any identified underlying issues. Oracle does not monitor, or address deviations experienced by any non-Oracle managed components used by You in the Oracle Cloud Services, such as non-Oracle applications. 

3.4.1  Customer Monitoring & Testing Tools 

Oracle permits You to conduct limited functional testing for Oracle Cloud Services in Your test instance. Specific rules for testing may be found in the Oracle’s Corporate Security Practices, available 
...
Oracle performs changes to cloud hardware infrastructure, operating software, product software, and supporting application software that is provided by Oracle as part of the Oracle Cloud Services, to maintain operational stability, availability, security, performance, and currency of the Oracle Cloud Services. Oracle follows formal change management procedures to review, test, and approve changes prior to application in the service. 
...
Oracle reserves specific maintenance periods for changes that may require the Oracle Cloud Services to be unavailable during the maintenance period. Oracle works to ensure that change management procedures are conducted during scheduled maintenance periods (of which Oracle shall give advanced notice), while taking into consideration low traffic periods and geographical requirements. 

Oracle will provide prior notice of modifications to the maintenance period schedule. For Customer-specific changes and upgrades, where feasible, Oracle will coordinate the maintenance periods with You. 

For changes that are expected to cause service interruption, the durations of the scheduled maintenance periods are not included in the calculation of Unplanned Downtime minutes in the monthly measurement period for Service Availability Level (see the Oracle Cloud Service Level Agreement above). Oracle uses commercially reasonable efforts to minimize the use of scheduled maintenance and to minimize the duration of maintenance periods that cause service interruptions. 
...
Oracle may be required to execute additional security maintenance outside of scheduled maintenance periods to address an exigent situation (e.g., security vulnerability) with the Oracle Cloud Service or Oracle infrastructure that cannot be addressed except on an emergency basis. Oracle works to minimize additional security maintenance that requires a service interruption outside of scheduled maintenance periods and to the extent reasonable, will work to provide 24 hours prior notice for such maintenance. 

4.1.2  Data Center Migrations 

Oracle may migrate Your Oracle Cloud Services deployed in data centers retained by Oracle between data centers in the same Data Center Region as deemed necessary by Oracle. Oracle will provide a minimum of 30 days’ notice to You for data center migrations; provided that, such advance notice  

> Oracle Cloud Hosting and Delivery Policies Page 13 of 19

obligation does not apply to disaster recovery scenarios or to ensure Service continuity, as further described, where applicable, in the relevant Oracle Cloud Services Pillar documentation. 

4.1.3  Software Updates 

Oracle delivers Oracle Cloud Services on a continuous-update model and supports only the software versions that Oracle designates as supported releases for such Oracle Cloud Services. You must keep Your Cloud Services on supported releases and complete any required actions to maintain version currency. You acknowledge that failure to complete the update prior to the end of support for the applicable release may result in Oracle automatically performing the update or suspending access to the affected Oracle Cloud Services. Oracle’s obligations under these Delivery Policies (including the 

Oracle Cloud Service Continuity Policy, the Oracle Cloud Service Level Agreement , and the Oracle Cloud Support Policy ) apply only when You are on supported releases. Oracle is not responsible for performance, functionality, availability or security issues experienced with Oracle Cloud Services that may result from running earlier versions. 

4.1.4  End of Life 

Where reasonably practical, Oracle will provide at least 12 months' advance notice before an Oracle Cloud Service is designated as End of Life (EOL) and retired. Oracle Cloud Services designated as EOL are no longer generally available, are not supported, and will not receive technical support or any updates, such as security patches, bug fixes, or compliance updates, and will not have SLA coverage. If an Oracle Cloud Service reaches EOL, Oracle may designate a successor Oracle Cloud Service and require You to transition to such Service. 
...
• 24x7x365 access to a Cloud Customer Support Portal designated by Oracle to log service requests 
...
Your technical contacts may access live support using Oracle’s web-based customer support systems or by telephone, as available. 
...
• Security Incident with the potential to impact the confidentiality, integrity or availability of the service Oracle will use reasonable efforts to respond to Severity 1 service requests within fifteen (15) minutes. Throughout the period during which Oracle is working to address a Severity 1 service request, You agree to make available Your technical contact 24x7. Oracle will work 24x7 until the Severity 1 service request is resolved, a reasonable work-around is put in place, an approved action plan is in place or the Customer’s 24x7 contact is no longer available. You must provide Oracle with a technical contact during this 24x7 period to assist with data gathering, testing, and applying fixes. You are required to 

propose this severity classification with great care, so that valid Severity 1 situations obtain the necessary resource allocation from Oracle. 
...
The Oracle Artificial Intelligence Terms available online at  http://oracle.com/contracts  apply to Artificial Intelligence Functionality (as defined in such terms) in Your ordered Cloud Services. 

## 8.  USE OF SERVICES 

You are responsible for ensuring that access and use of acquired Oracle Cloud Services, and the benefit received from such Cloud Services, is only by and for Users in countries in accordance with  
