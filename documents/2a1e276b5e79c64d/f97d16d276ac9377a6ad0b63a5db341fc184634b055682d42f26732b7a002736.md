...
URL Source: https://intl.cloud.tencent.com/document/product/301/17345
...
We will use the collected information to create and verify your account, enable password change, process payments, and to communicate with you. See below at [How we use Your Personal Information](https://intl.cloud.tencent.com/document/product/301/17345#2) for more information.

### Where do we process the collected personal information?

### How long do we hold on to the collected personal information?

Your information is retained so long as your account exists. After which, the information is deleted within a set time period, depending upon the type of personal information. See below at [Data Retention](https://intl.cloud.tencent.com/document/product/301/17345#4) for more information.
...
If you have any concerns or complaints, please contact us at cloudlegalnotices@tencent.com. See below at [Contact & Complaints](https://intl.cloud.tencent.com/document/product/301/17345#6) for more information.

### How will we notify you of changes?

If there are any significant changes to this privacy policy, we will provide a notice on our website. See below at [Updates & Changes](https://intl.cloud.tencent.com/document/product/301/17345#7) for more information.

### Contact Information

_Data Controller (EEA, UK and Switzerland)_: Tencent Cloud Europe B.V.. Address: Atrium building, 8th floor, Strawinskylaan 3127, 1077 ZX Amsterdam, the Netherlands.

_Data Controller (Outside EEA, UK and Switzerland)_: The entity you have contracted with, as set out in the [Terms of Service](https://intl.cloud.tencent.com/document/product/301/9248).

_Data Protection Officer_: Please email cloudlegalnotices@tencent.com.
...
**Personal Information****Purpose of Use****Legal Basis for Processing (only applicable for the EEA and UK)****Legal Basis for Processing (only applicable for South Korea)**
**Account data**: Name, email address, address (including city, province and post code), location, username, Tencent Cloud ID, APPID, UIN, other login security credentials, encrypted credit card number, mobile number, if you choose to register via Google: Google ID, email address, authentication code and avatar (in the form of a log); if you choose to register via WeChat: WeChat ID, nickname, avatar, gender, location (mandatory)

**Photo ID**: E.g., driver's license, passport or work permit (mandatory)

**Technical data**: IP address, user agent (or website browser), Device ID (mandatory)We use this information for account management, verification and security protection:

We use your account data (except encrypted credit card number) and technical data to create and/or verify your Tencent Cloud account and allow for password resets.

If you have been referred by another user, we use your UIN and name to identify you for referral purposes.

We use your mobile number, email address and address for security protection (if you activate account verification, your information will be used to send you SMS alerts and two-factor authentication codes when you modify account passwords, email addresses, etc.) and service information.

We use your photo ID (or, where you are a corporate customer, corporate documentation) to ensure that your account is legally verified in accordance with local law, if you elect to use servers located in the PRC (excluding Hong Kong (China), Macau (China) and Taiwan (China)) for the Services described in the PRC addendum below.

We use your account data and technical data to enforce our terms, conditions and policies, in order to provide a safe and secure environment, and to maintain the integrity of the Services.

We use your account data to enable you to purchase cloud services offered by third parties on our Marketplace.We process your account data and technical data as it's necessary for us to perform our contract with you to provide the Services.

It is in our legitimate interests to process your mobile number, email address and address to verify your identity and communicate with you about the Services.

It is in our legitimate interests to process your photo ID to ensure you are able to activate the Services for use in jurisdictions where this is a legal requirement.We process your account data and technical data without your consent, pursuant to Article 15(1)(iv) of the Personal Information Protection Act ("**PIPA**") (i.e., for execution and performance of a contract).

We process your Photo ID without your consent, pursuant to Article 15(1)(ii) (i.e., according to statutory provision or obligation), Article 24(1)(ii) (i.e., where processing of unique identification information is specifically allowed or required under the law) or Article 24-2(1)(i) (i.e., where processing of resident registration number is specifically allowed or required under the law) of the PIPA.
**Credit card information**: Card number, name, expiration date, security code, payment ID (mandatory)

**Transaction records and order information**: E.g., order number, amount, referral fee (if applicable) date and time of payments (mandatory)

**Account data**: Name, email address, address (including city, province and post code), location, username, Tencent Cloud ID, APPID, UIN, other login security credentials, mobile number, business email, phone number, company name, country/region, industry, if you choose to register via Google: Google ID, email address, authentication code and avatar (in the form of a log); if you choose to register via WeChat: WeChat ID, nickname, avatar, gender, location (mandatory)

**Technical data**: IP address, user agent (or website browser), Device ID (mandatory)We use this information for payment and transaction management:

We use your credit card information to process payments made by you for use of the Services.

We provide access to your transaction records so that you can see your transaction history.

We use your account data and technical data to record transactions, and to provide order confirmations, product notifications and account balance information.

We use your order information and IP address to confirm your participation in the referral programme and calculate your referral fee.

We use your Transaction Records and share it with the respective third party provider to manage the billing of your subscription of cloud services offered by third parties on Marketplace.We process your credit card information as it's necessary for us to perform our contract with you to facilitate payment for the Services.

We process your transaction records as it's necessary for us to perform our contract with you to manage payments in respect of the Services.

We process your account data and technical data as it's necessary for us to perform our contract with you to provide the Services.

It is in our legitimate interests to process your mobile number, email address and address to communicate with you about the Services.We process your credit card information, transaction records, account data, and technical data without your consent, pursuant to Article 15(1)(iv) of the PIPA (i.e., for execution and performance of a contract).
**Technical data**: Metadata and log data (including in relation to incidents), IP address, user tickets, user agent, date and time of access, each URL visit within the Tencent Cloud website whether direct or referred from third party website (mandatory)

**Customer complaint data**: Customer Service Ticket/ Chat content, IP address, Tencent Cloud ID, incident details and response steps and information on the cloud resources purchased and error messages received, if you choose to enquire via Telegram: Telegram user's account number (mandatory)

**Enquiry data**: Data provided when you submit a technical support request, an enquiry via our website contact form or as part of a sales enquiry, including: your name, email, phone number, UIN, priority of query or ticket, reminder settings, company name, business service, location, and details of your query or any additional information provided by you (mandatory)We use this information for service improvement and support:

We use technical data and customer complaint data to improve our strategy and responses, improve and administer our Services, and for internal operations, including troubleshooting, data analysis, testing, research, statistical and survey purposes, and to keep our Services safe and secure.

We use customer complaint data to deal with your concerns and complaints about the Service.

We use enquiry data to respond to your request.It is in our legitimate interests to process technical data and customer complaint data to improve our strategy, responses and Services, and to provide support in connection with the Services supplied to you.

It is in our legitimate interests to process enquiry data as it is needed to respond to your request.We process your technical data, customer complaint data, and enquiry data without your consent, pursuant to Article 15(1)(iv) of the PIPA (i.e., for execution and performance of a contract).
**Contact data**: Name, email address, phone number, company name, business service, location, country/region, industry, country code, details of your query (optional for product promotion and marketing; mandatory for other communications)Aside from location and country/region, we use your contact data for marketing and communications:

To promote our products and services to you; to send you direct marketing communications through us or our third party partners; and to reserve you a place on our online events and webinars.

To communicate (whether through us or our third party partners) with you, in order to understand products and services that may interest you, and to explore potential business opportunities with you.

We also collect this information from our third party cloud vendors/service providers in order to register them as a service provider on Marketplace.We process your contact data for product promotion and direct marketing with your consent. You can withdraw this consent at any time.

It is in our legitimate interests to process your contact data to maintain a relationship with you and to better understand your business needs.We process your contact data for product promotion and marketing based on your consent, pursuant to Article 15(1)(i) of the PIPA (i.e., according to data subject's consent).

We process your contact data for other communications without your consent, pursuant to Article 15(1)(iv) of the PIPA (i.e., for execution and performance of a contract).
**Compliance data**: Name, email address, and any other information you provided for us to comply with the legal obligation (e.g. date of birth, nationality, business registration date, business registration number, place of business registration) (mandatory)We use this information to comply with our legal obligations.We process this information as it's necessary for us to comply with the legal obligations that we are subject to.We process your compliance data without your consent, pursuant to Article 15(1)(ii) of the PIPA (i.e., according to statutory provision or obligation).
...
**Related group companies**, including the entities listed on our [Third Parties](https://intl.cloud.tencent.com/document/product/1033/32281) page, with whom we share your personal information to operate our Services including in connection with referrals made by their users.
...
**Account data**: Name, email address, address (including city, province and post code), password, location, username, Tencent Cloud ID, APPID, UIN, verification code, other login security credentials, encrypted credit card number, mobile number, if you choose to register via Google: Google ID, email address, authentication code and avatar (in the form of a log); if you choose to login your account via WeChat: WeChat ID, nickname, avatar, gender, location

**Photo ID**: E.g., driver's license, passport or work permit Account data and photo ID are held for so long as an account exists. Information is erased within thirty (30) days of the date the account is deleted.

Google and WeChat login credentials are retained until the expiry of a 90-day period from its creation.

Only the location based on the IP addresses of the previous three (3) logins are retained.
**Technical data**: Metadata and log data (including in relation to incidents), IP address, user tickets, user agent (or website browser), Device ID, date and time of access, each URL visit within the Tencent Cloud website whether direct or referred from third party website Technical data (except for log data) is held for so long as an account exists. Information is erased within thirty (30) days of the date the account is deleted.

Log data (including in relation to incidents) is held for 3 months from the date of collection.
**Credit card information**: Payment ID (we do not store your other credit card information including card number, name, expiration date and security code, except for the purposes of acquiring a payment ID which is provided by our payment processor upon receiving your other credit card information)Payment ID is held for so long as an account exists. Information is erased within thirty (30) days of the date the account is deleted.
**Transaction records and order information**Transaction records are held for as long as an account exists. Information is erased within ninety (90) days of the date the account is deleted.
**Customer complaint data**: Customer Service Ticket/ Chat content, IP address, Tencent Cloud ID, incident details and response steps, if you choose to enquire via Telegram: Telegram user's account number

**Enquiry data**: Data provided when you submit a technical support request, an enquiry via our website contact form or as part of a sales enquiry, including: your name, email, phone number, WeChat/ Telegram/ WhatsApp/ LINE account ID, UIN, priority of query or ticket, reminder settings, company name, business service, location, and details of your query or any additional information provided by you Customer complaint data and enquiry data is held until the case is resolved, and then erased within one hundred and eighty (180) days of such resolution, unless you agree to have this data retained and receive more information in the future.
**Contact data**: Name, email address, phone number, WeChat/ Telegram/ WhatsApp/ LINE account ID, company name, business service, location, country/region, country code, details of your query Such data is held until you tell us that you no longer wish to receive promotional information.
**Contact data** (for B2B marketing): Name, email address, country code, phone number and company name This data is held for so long as an account exists. Information is erased within thirty (30) days of the date the account is deleted.
...
NEOCRM (S) PTE. LTD.Client relationship management and marketing support
Tencent Cloud International Pte. Ltd.Account Management
WeChat Login via WeChat account
...
**Legal Basis****Recipient (Contact Information of Information Manager)****Country to which Your Personal Information is to be Transferred****Date and Method of Transfer****Types of Your Personal Information to be Transferred****Purposes of Use by Recipients****Period of Retention Use by Recipient**
PIPA Article 28-8 (1)(3) (Delegation and Retention for Contract Performance)Tencent Cloud International Pte. Ltd.

cloudlegalnotices@tencent.com Singapore Online transmission or Encrypted transmission All personal information that is stored Storage Please refer to "[Data Retention](https://intl.cloud.tencent.com/document/product/301/17345#4)" section above
PIPA Article 28-8 (1)(3) (Delegation and Retention for Contract Performance)Image Frame Investment (HK) Limited

dataprotection@tencent.com Hong Kong Online transmission Mobile number, SMS content SMS Sending Account data is held for so long as an account exists. SMS messages are deleted 13 months after the SMS messages have been sent.
PIPA Article 28-8 (1)(3) (Delegation and Retention for Contract Performance)NEOCRM (S) PTE. LTD.

privacyofficer@neocrm.com Singapore Online transmission Promotional Contact Data
...
Billing address, billing country, billing street, billing city, billing state/province, billing zip/postal code Client relationship management and marketing support Please refer to the retention periods set out in "[Data Retention](https://intl.cloud.tencent.com/document/product/301/17345#4)", subject to termination of the contractual relationship between us and Salesforce, in which case data will be deleted within 300 days from termination.
PIPA Article 28-8 (1)(3) (Delegation and Retention for Contract Performance)Tencent Cloud Computing (Beijing) Co., Ltd.

meeting_info@tencent.com People's Republic of China Online transmission upon account creation and payment**Mandatory**: Date of birth, name, mobile phone number, email address, location, address (including city and post code), type of business, password System operation and maintenance Account data is held for so long as an account exists. Information is erased within thirty (30) days of the date the account is deleted. (For location information based IP addresses used for the purposes of account verification, the location of the IP addresses of only the previous three (3) logins are retained)
PIPA Articles 28-8 (1)(1), 17(1)(1) (Consent of Data Subject)Tencent Cloud Computing (Beijing) Co., Ltd.

meeting_info@tencent.com People's Republic of China Online transmission upon account creation and payment**Optional**: Photo ID (e.g., driver's license, passport, work permit or business license) name and address To ensure that your account is legally verified in accordance with local laws in the PRC Account data is held for so long as an account exists. Information is erased within thirty (30) days of the date the account is deleted.
PIPA Articles 28-8 (1)(1), 17(1)(1) (Consent of Data Subject) / PIPA Article 28-8 (1)(3) (Delegation and Retention for Contract Performance)Tencent Cloud Computing (Beijing) Co., Ltd.

meeting_info@tencent.com People's Republic of China Online transmission upon account creation and payment**Optional**: UIN, name, IP address, details of first order (order number, amount, referral fee)To administer user's participation in the referral programme Data is held for so long as an account exists.
PIPA Articles 28-8 (1)(1), 17(1)(1) (Consent of Data Subject)Google Inc.

https://policies.google.com/privacy United States Transmitted if user logs in using Google ID Log-in credentials Log-in In accordance with the [Google Identity Platform terms](https://developers.google.com/identity)
PIPA Article 28-8 (1)(3) (Delegation and Retention for Contract Performance)AroundDeal Holdings Limited

tim.s@arounddeal.com United States Encrypted transmission Corporate Website Visitor Information (as defined in Real-Time Communication (TRTC)'s Privacy Policy Module)Purpose as specified in TRTC's Privacy Policy Module Deleted by AroundDeal (i) within 3 years from the termination of the contractual relationship between us and AroundDeal, or (ii) upon receipt of our data deletion request (whichever is earlier)
...
Act on the Consumer Protection in Electronic Commerce, Etc.Article 6 of the Act on the Consumer Protection in Electronic Commerce, Etc.

Article 6 of the Implementation Decree of the Act on the Consumer Protection in Electronic Commerce, Etc.In an electronic commerce or a mail-order sale:
...
Protection of Communications Secrets Act Article 15-2 of the Protection of Communications Secrets Act

Article 41 of the Implementation Decree of the Protection of Communications Secrets Act Log records, IP address (3 months)

The date of telecommunications by users, the time that the telecommunications started and ended, the interlocutor's subscription number such as incoming and outgoing numbers, the frequency of use (12 months)
...
_**Collection, Use and Disclosure of Personal Information**_

_**Over the past 12 months, through your use of the Services, we may have collected and disclosed the following categories of personal information, including sensitive personal information (as denoted by *):**_
...
_**We collect personal information for the following purposes and as described in the applicable Module:**_
...
_**How to Exercise Your Rights**_
...
_Instructions for the processing of your personal data after your death._
...
_Sharing Of Your Sensitive Personal Information_
...
_Language of this Privacy Policy_
...
_Right of access_: You have the right to request access to and obtain a copy of your personal information that we have collected and is being processed by or on behalf of us. We reserve the right to impose a fee for providing access to your personal information in the amounts as permitted under law.
...
_Right of correction_: You may request for the correction of your personal information. When handling a data correction request, we are permitted to request for certain information to verify the identity of the requester to ensure that he/she is the person legally entitled to make the data correction request.

_Right to limit processing of your personal information_: You may request to limit the processing of your personal information by using the contact details provided above. However this may affect our provision of the Service to you.
...
_Right to be informed_. You have the right to be informed whether personal data pertaining to you shall be, is being, or have been processed, including the existence of automated decision-making and profiling.

_Right to object_. You shall have the right to object to the processing of your personal information, including processing for direct marketing, automated processing or profiling. When you object or withhold consent, we shall no longer process your personal data, unless the personal data is needed pursuant to a subpoena; the collection and processing are for obvious purposes, including, when it is necessary for the performance of or in relation to a contract or service to which you have bound yourself; or your personal information is being collected and processed as a result of a legal obligation.

_Right to access_. You have the right to reasonable access to, upon demand, the following:
...
transferring or storing your personal information in destinations outside the Philippines when the processing shall need to occur outside the Philippines, as described in the section "[How We Disclose and Store Your Personal Information](https://intl.cloud.tencent.com/document/product/301/17345#3)".
...
The paragraph headed "_The Security of Your Personal Information_" in the Tencent Cloud Privacy Policy is inapplicable with respect to personal data collected in Türkiye.
...
_Transfer, Location and Retention of Personal Information_
