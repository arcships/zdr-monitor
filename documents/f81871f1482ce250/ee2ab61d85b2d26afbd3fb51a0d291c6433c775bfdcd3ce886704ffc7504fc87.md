...
URL Source: https://cline.bot/privacy

Markdown Content:
## CLINE PRIVACY NOTICE

**Last Updated**: September 24, 2025

Welcome to Cline—a software development agent that uses frontier models to write, edit, and build software. This Privacy Notice explains how Cline Bot Inc. (“Cline”) collects, uses, discloses, and otherwise processes personal data in connection with the Cline extensions (including our Visual Studio Code extension and our JetBrains extension), the Cline app, and the cline.bot website.

This Privacy Notice does not address our privacy practices relating to Cline job applicants, employees and other employment-related individuals. Data that is not subject to applicable data protection laws (such as deidentified or publicly available information) is also out of scope.
...
**User Content**, including any files, documents, audio, videos, images, data, or communications you choose to input, upload, or transmit to our products and services. If you use your own API keys to access the AI model, you provide this information directly to the third-party provider, and we do not collect it. However, if you use API keys provided by Cline rather than your own, we collect this information in order to facilitate your requests to third-party AI model providers on your behalf.
...
Cookies are small text files that are stored on your device when you visit a website. We use cookies and similar technologies for various purposes, including to enhance your experience, analyze traffic, and personalize content. We categorize cookies as follows:

**Necessary Cookies**: These cookies are essential for the website to function properly. They enable core functionality such as security, network management, and account access. You cannot disable these cookies through our consent management system.

**Analytics Cookies**: These cookies help us understand how visitors interact with our website by collecting and reporting information anonymously. They allow us to measure and improve the performance of our site. These cookies are provided by services such as Google Analytics.

**Marketing Cookies**: These cookies are used to track visitors across websites. They are set to display targeted advertisements based on your interests and online behavior. They also help measure the effectiveness of advertising campaigns.

**Preferences Cookies**: These cookies enable the website to remember choices you make and provide enhanced, personalized features. They may be set by us or by third-party providers whose services we have added to our pages.

You can manage your cookie preferences at any time by clicking on the "Manage Preferences" button in our cookie banner. Your consent preferences are stored for 12 months, after which you will be asked to renew your consent choices.
...
**Our Affiliates**: We are able to offer you the products and services we make available because of the hard work of our team members across all Cline entities. To provide our products and facilitate our services, Cline entities receive personal data from other Cline entities for purposes and uses that are consistent with this Privacy Notice.

**AI Model Providers**: If you use your own API keys to access the AI model, you receive output data, which may include personal data, directly from the third-party provider, and we do not collect it. However, if you use API keys provided by Cline rather than your own, we receive output data, which may include personal data, from the AI model provider in order to facilitate transmitting it to you.
...
*   Detect, prevent, investigate, or provide notice of security incidents or other malicious, deceptive, fraudulent, or illegal activity and protect the rights and property of Cline and others;
...
We provide a cookie consent management system that allows you to choose which types of cookies you allow us to use. You can access this system through the "Manage Preferences" button in our cookie banner or by clicking on the cookie preferences link in the footer of our website. Your choices are stored for 12 months, after which you will be asked to renew your consent.
...
**Device-Specific Opt-Out Programs**: Certain devices provide individuals the option to turn off targeted advertising for the entire device. Please refer to your device manufacturer's user guides for additional information about implementing any available device-specific targeted advertising opt-outs.

**Digital Advertising Alliance**: The Digital Advertising Alliance allows individuals to opt out of receiving online interest-based targeted advertisements from companies that participate in their program. Please follow the instructions at[https://optout.aboutads.info/?c=2&lang=EN](https://optout.aboutads.info/?c=2&lang=EN)for browser-based advertising to opt out of targeted advertising carried out by our third-party partners and other third parties that participate in the Digital Advertising Alliance's self-regulatory program.

**Network Advertising Initiative**: The Network Advertising Initiative similarly allows individuals to opt out of receiving online interest-based targeted advertisements from companies that participate in their program. Please follow the instructions at[https://optout.networkadvertising.org/?c=1](https://optout.networkadvertising.org/?c=1)to opt out of browser-based targeted advertising carried out by our third-party partners and other third parties that participate in the Network Advertising Initiative's self-regulatory program.
...
**Google Analytics**: Google Analytics allows us to better understand how our customers interact with our services. For information on how Google Analytics collects and processes data, as well as how you can control information sent to Google, review Google's website here:[www.google.com/policies/privacy/partners/](https://www.google.com/policies/privacy/partners/). You can learn about Google Analytics' currently available opt-outs, including the Google Analytics Browser Add-On here:[https://tools.google.com/dlpage/gaoptout/](https://tools.google.com/dlpage/gaoptout/). We may also utilize certain forms of display advertising and other advanced features through Google Analytics. These features enable us to use first-party cookies (such as the Google Analytics cookie) and third-party cookies (such as the DoubleClick advertising cookie) or other third-party cookies together to inform, optimize, and display ads based on your past visits to our services. You may control your advertising preferences or opt-out of certain Google advertising products by visiting Google's My Ad Center, currently available at[https://myadcenter.google.com/?ref=help-center](https://myadcenter.google.com/?ref=help-center).
...
If you have any questions or requests in connection with this Privacy Notice or other privacy-related matters, please contact us at[support@cline.bot](mailto:support@cline.bot).
