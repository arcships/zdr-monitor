...
Audio
Supported models
`tts-1``whisper-1``gpt-4o-tts`+ 3 model snapshots
...
Fine-tuning
Supported models
`gpt-4o-2024-08-06``gpt-4o-mini-2024-07-18``gpt-4.1-2025-04-14`+ 1 model snapshot
`gpt-4.1-mini-2025-04-14`
/v1/images/edits
Images
Supported models
`gpt-image-2``gpt-image-1``gpt-image-1.5`+ 1 model snapshot
`gpt-image-1-mini`
...
Realtime
Supported models
`gpt-realtime``gpt-realtime-1.5``gpt-realtime-mini`+ 3 model snapshots
...
| Supported input modalities | Other |
`Text``Image``Audio/Voice`
#### Support by region
...
`Scale Tier`
`Structured Outputs (excluding schema)`
`Supported input modalities` | None |
