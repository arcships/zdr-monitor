...
Log inDashboard
# Unified Billing
Last updated Sep 23, 2026|Copy as Markdown|View as Markdown|Agent setup
...
1. Log in to the Cloudflare dashboard ↗︎ and go to **AI** > **AI Gateway**.
Go to **AI Gateway** ↗
...
Refer to the model catalog to check whether a model supports Zero Data Retention (ZDR).
Was this helpful?
YesNo
## On this page
Docs
