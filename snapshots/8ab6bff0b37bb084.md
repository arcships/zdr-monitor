<!-- https://docs.warp.dev/enterprise/security-and-compliance/security-overview.md -->
...
- **Open source client** - Warp’s client code is published under AGPL v3 at `warpdotdev/warp`, so security teams can audit the codebase directly. See Contributing to Warp for the source repository and the security reporting process.
...
- Warp privacy policy
- Warp Trust Center — security documentation and compliance reports. See also Trust Center for details on requesting SOC 2 reports, subprocessors, and vendor security assessments.
- Warp subprocessors list
- **Privacy documentation** - Privacy guide with complete telemetry table
- **Contact** - privacy@warp.dev for privacy questions, security@warp.dev for security issues
Note
For vendor security assessments, compliance questionnaires, or access to SOC 2 reports, contact your account manager or email security@warp.dev.
