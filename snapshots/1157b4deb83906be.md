...
Management Console
Security Control
Home PageAlibaba Cloud Model StudioUser Guide (Models)Security and ComplianceSecurity certifications and privacy
# Security certifications and privacy
Updated at: 2026-09-20 18:11:30
Copy as MD
Product
...
Reference: Compliance repository
## Privacy protection
...
In compliance with relevant laws and regulations, Alibaba Cloud Model Studio stores data generated from model and application calls. For more information, see the terms regarding data processing, privacy, and security in the Related agreements.
Previous: Access Model Studio APIs over a private networkNext: Training data summary
