...
Use `jev-1.13-free` instead of `jev-1.13` to use the limited-time free model. See the TypeSafe AI documentation for details about question types and response fields.
## Pricing
