<!-- https://dataplatform.cloud.ibm.com/docs/content/wsj/analyze-data/fm-security.html?context=wx -->
0 / 0
Confirm
Do you want to log out?
CancelLog out
Give us your feedback on watsonx
Works wellNeeds improvement
Why didn’t you like your experience?
Ran into an errorInstructions unclearCan't finish a taskOther
Comments
...
| Prompt in transit | Not applicable | No | • Prompt remains encrypted while in transit.
• The foundation models are hosted in IBM Cloud or AWS; your prompts are not sent to third-party platforms. |
...
• If watsonx.governance is provisioned, you can optionally monitor foundation model output. |
...
| Prompt Lab text in web browser cache | Not applicable | No | • Unsaved prompt text is kept in the web page until the session expires or the page is refreshed, at which time the prompt text is deleted.
...
- For more information about asset security, see Data security.
- For more information about managing project access, see Project collaborators
...
## Learn more
Copy link to section
- Setting up IBM Cloud Object Storage for use with watsonx
- Watsonx terms
- IBM watsonx.ai Runtime terms
- IBM watsonx.ai Studio terms
- IBM watsonx.ai AWS terms
- Managing assets in projects
- Security for IBM watsonx.ai
- Data security
