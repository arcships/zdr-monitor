...
Management Console
Security Control
Home PageAlibaba Cloud Model StudioUser Guide (Models)Token PlanToken Plan overview
# Token Plan overview
Updated at: 2026-09-23 00:15:30
Copy as MD
Product
...
**Note**
Token Plan is currently available only in the **Singapore** region. Switch the region to **Singapore** in the upper-left corner of the Model Studio console to purchase and use.
## Product overview
...
6-8
**Purchase conditions**
Requires an active subscription; up to 5
**Models**
Supports multiple models for text generation, image generation, video generation, speech recognition, real-time voice conversation, and more (View full list)
**Harness tools**
Supports multiple Harness tools, billed in Credits (View details)
## Team Edition
**Standard seat**
**Pro seat**
**Max seat**
...
**Shared quota pack**
**Pricing**
Original price $30/seat/month
Limited-time **$20/seat/month**
Original price $100/seat/month
Limited-time **$75/seat/month**
**$200/seat/month**
$700/pack/month
**Monthly quota**
...
**Models**
**Team management**
Supports multi-seat management and usage analytics (Team management)
**Harness tools**
## Plan quotas
### Personal Edition
...
Previous: Budget managementNext: Personal Edition
