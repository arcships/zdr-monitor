<!-- https://raw.githubusercontent.com/Clarifai/docs/main/docs/product-updates/upcoming-api-changes/secure-data-hosting.md -->
...
## How it Works
You can start by using the `ListInputs` endpoint to list all the inputs in your app.
