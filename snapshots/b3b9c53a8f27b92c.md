<!-- https://www.ibm.com/docs/en/watsonx/saas?topic=cloud-security-policies-responsibilities-in -->
...
Change version
SaaSIBM watsonx.dataIBM watsonx.ai and watsonx.governanceIBM watsonx OrchestrateIBM watsonx Assistant for ZIBM watsonx Code Assistant for ZIBM watsonx.data intelligence and watsonx.data integration
...
To use HIPAA-ready generative AI capabilities with watsonx.ai, you must sign up for the watsonx.ai Runtime HIPAA-Ready plan in the Dallas (US South) region. For more information about the how to access the HIPAA-Ready plan and the supported features, see watsonx.ai Runtime HIPAA-Ready plan details.
## IBM's commitment to GDPR
...
- Use the watsonx.ai Runtime REST to delete assets or deployments.
...
- IBM and GDPR
- Software Product Compatibility Reports: IBM watsonx.ai Studio Data Processing and Protection Datasheet
- Software Product Compatibility Reports: IBM watsonx.ai Runtime Data Processing and Protection Datasheet
