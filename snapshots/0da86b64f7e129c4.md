<!-- https://raw.githubusercontent.com/huggingface/hf-endpoints-documentation/main/docs/source/support/faq.md -->
# FAQs
## General questions
...
The Inference Providers is a solution to easily explore and evaluate models. Its a
...
You can currently monitor your Endpoint through the Inference Endpoints web application,
where you have access to the Logs of your Endpoints as well as a
metrics dashboard.
## Security
...
You can invalidate existing personal tokens and create new ones in your settings here: https://huggingface.co/settings/tokens.
...
depending on the scaling strategy you configured. We recommend reading the autoscaling section for more information
...
Yes, you can deploy any repository from the Hugging Face Hub and if your task/model/framework is not
supported out of the box. For this we recommended setting up a custom container
