<!-- https://platform.stepfun.ai/docs/en/guides/developer/prompt-cache -->
> ## Documentation Index
...
There is no separate paid cache feature to enable. Uncached input tokens, including the first write to the cache, use the cache-miss input rate; cached input tokens use the cache-hit input rate. For `step-5-preview`, the cache-hit input rate is 5% of the cache-miss input rate. See Pricing and Rate Limits.
