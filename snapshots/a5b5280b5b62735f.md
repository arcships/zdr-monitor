...
- **Prompt logging for abuse monitoring**: As outlined in the Gemini API Additional Terms of Service, for Paid Services, Google logs prompts and responses for a limited period of time solely for detecting violations of the Prohibited Use Policy. If your workload requires guaranteed zero data retention or enterprise data processing agreements, use Vertex AI. For details, see Gemini Enterprise Agent Platform and zero data retention.
