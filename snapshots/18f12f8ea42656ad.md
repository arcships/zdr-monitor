...
Logs
We do not log the content of your requests. We log only metadata useful for debugging: request ID, cost, sampling parameters. When using the Google model, Google logs prompts and responses for a limited period solely to detect violations of their Prohibited Use Policy.
